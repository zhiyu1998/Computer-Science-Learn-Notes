...
(function (global, factory) {
  ...
  function printWarning(level, format, args) {
    ...
    // update consoleWithStackDev.www.lib as well.
    {
  ...
  function describeComponentFrame (name, source, ownerName) {
    ...
    if (source) {
...

      {
        ...
        // prefer "folder/index.lib" instead of just "index.lib".
  ...
  function setDefaultValue(node, type, value) {
    if ( // Focused number inputs synchronize on blur. See ChangeEventPlugin.lib
  ...
  /**
   * @ReactInputSelection: React input selection module. Based on Selection.lib,
    ...
    if (mixedRef !== null && typeof mixedRef !== 'function' && typeof mixedRef !== 'object') {
      {
        ...
        if ((returnFiber.mode & StrictMode || warnAboutStringRefs) && // We warn in ReactElement.lib if owner and self are equal for string refs
  ...
  var Internals = {
    // Keep in sync with ReactDOMUnstableNativeDependencies.lib
    // ReactTestUtils.lib, and ReactTestUtilsAct.lib. This is an array for better minification.

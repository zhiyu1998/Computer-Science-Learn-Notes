import{_ as e,W as t,X as p,a0 as n,a1 as s,Z as o,$ as i,C as c}from"./framework-afce0fe7.js";const l={},u=n("h2",{id:"剑指-offer-18-删除链表的节点",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#剑指-offer-18-删除链表的节点","aria-hidden":"true"},"#"),s(" 剑指 Offer 18. 删除链表的节点")],-1),d={href:"https://leetcode.cn/problems/shan-chu-lian-biao-de-jie-dian-lcof/?favorite=xb9nqhhg",target:"_blank",rel:"noopener noreferrer"},r=i(`<h3 id="解法1" tabindex="-1"><a class="header-anchor" href="#解法1" aria-hidden="true">#</a> 解法1</h3><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token doc-comment comment">/**

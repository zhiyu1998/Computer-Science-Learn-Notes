...
<h1 id="堆的核心概述" tabindex="-1"><a class="header-anchor" href="#堆的核心概述" aria-hidden="true">#</a> 堆的核心概述</h1>
<h2 id="认识堆内存" tabindex="-1"><a class="header-anchor" href="#认识堆内存" aria-hidden="true">#</a> 认识堆内存</h2>
<ul>
<li>一个进程对应一个JVM实例</li>
<li>一个JVM实例对应一个堆空间</li>
<li>进程包含多个线程，所以线程之间共享同一个堆空间</li>
</ul>
<figure><img src="@source/Java/jvm/part1/images/5xuChryJu80-Tkpdbi27ng63nUeL8pXiawMLcxKCII8.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<ul>
<li>一个JVM实例只存在一个堆内存，堆也是Java内存管理的核心区域。</li>
<li>Java堆区<strong>在JVM启动的时候即被创建</strong>，其空间大小也就确定了，<code v-pre>堆是JVM管理的最大一块内存空间</code>。
<ul>
<li><strong>堆内存的大小是可以调节的</strong>。</li>
</ul>
</li>
<li>《Java虚拟机规范》规定，<strong>堆可以处于物理上不连续的内存空间中，但在逻辑上它应该被视为连续的</strong>。</li>
<li>所有的线程共享Java堆，在这里还可以划分<strong>线程私有的缓冲区</strong>（Thread Local Allocation Buffer，TLAB）。</li>
<li>《Java虚拟机规范》中对Java堆的描述是：<strong>所有的对象实例以及数组都应当在运行时分配在堆上</strong>。（The heap is the run-time data area from which memory for all class instances and arrays is allocated）</li>
<li>从实际使用角度看的：“几乎”所有的对象实例都在这里分配内存。因为还有一些对象是在栈上分配的（逃逸分析，标量替换）</li>
<li>数组和对象可能永远不会存储在栈上，因为栈帧中保存引用，这个引用指向对象或者数组在堆中的位置。</li>
<li>在方法结束后，<code v-pre>堆中的对象不会马上被移除</code>，仅仅在垃圾收集的时候才会被移除。
<ul>
<li>也就是触发了GC的时候，才会进行回收</li>
<li>如果堆中对象马上被回收，那么用户线程就会收到影响，因为有 stop the word</li>
</ul>
</li>
<li><code v-pre>堆，是GC（Garbage Collection，垃圾收集器）执行垃圾回收的重点区域</code>。</li>
</ul>
<figure><img src="@source/Java/jvm/part1/images/HWKQ4tQz6gnsZPZ4RK449Y7D97KfYIr_6UhwQj5yPso.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<h2 id="代码示例" tabindex="-1"><a class="header-anchor" href="#代码示例" aria-hidden="true">#</a> 代码示例</h2>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">SimpleHeap</span> <span class="token punctuation">{</span>
...
<p>一个JVM实例只存在一个堆内存，并且堆内存的大小是可以调节的</p>
</blockquote>
<p>示例2：</p>
<p>Demo的VM选项为：-Xms10m    -Xmx10m</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">HeapDemo</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Demo1的VM参数为：-Xms20m    -Xmx20m</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">HeapDemo1</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="查看堆内存" tabindex="-1"><a class="header-anchor" href="#查看堆内存" aria-hidden="true">#</a> 查看堆内存</h2>
<p>在JDK文件Bin内：打开jvisualvm.exe</p>
<p>初次使用没有GC查看器，所以可以点击  工具--插件  下载</p>
<p>Demo（红色标记为把这些加在一起的大小就是设置的堆内存大小）</p>
<figure><img src="@source/Java/jvm/part1/images/y3pml_XolV6nSlmW2_u2zaIGs0CD6U5eDil18u8uvQE.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<p>Demo1</p>
<figure><img src="@source/Java/jvm/part1/images/SnU1fTcg78I0zLGk9y8ML8TcoZlowF53QBWga1oAO0Q.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<h2 id="堆内存分区" tabindex="-1"><a class="header-anchor" href="#堆内存分区" aria-hidden="true">#</a> 堆内存分区</h2>
<p>现代垃圾收集器大部分都基于分代收集理论设计，堆空间细分为：</p>
<ul>
<li>Java 7及之前堆内存逻辑上分为三部分：<code v-pre>新生区 + 养老区 + </code><strong>永久区</strong>
<ul>
<li>Young Generation Space 新生区 Young/New</li>
<li>又被划分为 <code v-pre>Eden区</code> 和 <code v-pre>Survivor区</code></li>
<li>Tenure generation space 养老区 Old/Tenure</li>
<li>Permanent Space永久区 Perm</li>
</ul>
</li>
</ul>
<figure><img src="@source/Java/jvm/part1/images/woLT-5i5UU7iWKwZNZ33OWrBZFqylmoIBHG8OXEuF6g.jpg" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<ul>
<li>Java 8及之后堆内存逻辑上分为三部分：<code v-pre>新生区 + 养老区 + </code><strong>元空间</strong>
<ul>
<li>Young/New Generation Space 新生区，又被划分为Eden区和Survivor区</li>
<li>Old/Tenure generation space 养老区</li>
<li>Meta Space 元空间 Meta</li>
</ul>
</li>
</ul>
<figure><img src="@source/Java/jvm/part1/images/-9AEN_je35csLbssE4spcOctd8SIZnrzS_sSs57zA30.jpg" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<p>从Jvisualvm中可以看</p>
<figure><img src="@source/Java/jvm/part1/images/8pk0Fs8hxBrNERdk_r7XM0aM3vfqgbDClfVrkdO3jVU.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<ul>
<li>约定：<code v-pre>新生区 = 新生代 = 年轻代</code>、 <code v-pre>养老区 = 老年区 = 老年代</code>、 <code v-pre>永久区 = 永久代</code></li>
<li>堆空间内部结构，JDK1.8之前从<code v-pre>永久代</code> 替换成 <code v-pre>元空间</code></li>
<li>堆空间逻辑上包括 <code v-pre>永久代/元空间</code>，实际上控制不到</li>
</ul>
<figure><img src="@source/Java/jvm/part1/images/5wFnckgq2e5bTL9ziAQzLijRZgFh2FGB8kJkhHu7EFk.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<p>示例代码：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">SimpleHeap</span> <span class="token punctuation">{</span>
    <span class="token keyword">private</span> <span class="token keyword">int</span> id<span class="token punctuation">;</span><span class="token comment">//属性、成员变量</span>
...
<blockquote>
<p>-Xms10m -Xmx10m -XX:+PrintGCDetails</p>
</blockquote>
<p>在Java8的条件下可以看到</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">Heap</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>java7环境下是</p>
<figure><img src="@source/Java/jvm/part1/images/Wg50jd0w8msymHYP187QyvijPDVeR1k3u_QYW2w0_1o.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<h1 id="设置堆内存大小与oom" tabindex="-1"><a class="header-anchor" href="#设置堆内存大小与oom" aria-hidden="true">#</a> 设置堆内存大小与OOM</h1>
<h2 id="设置堆空间大小" tabindex="-1"><a class="header-anchor" href="#设置堆空间大小" aria-hidden="true">#</a> 设置堆空间大小</h2>
<ul>
<li>Java堆区用于存储Java对象实例，那么堆的大小在JVM启动时就已经设定好了，大家可以通过选项&quot;-Xms&quot;和&quot;-Xmx&quot;来进行设置。
<ul>
<li><strong>-Xms</strong> 用于表示堆区的初始内存，等价于 <strong>-XX:InitialHeapSize</strong></li>
<li><strong>-Xmx</strong> 则用于表示堆区的最大内存，等价于 -<strong>XX:MaxHeapSize</strong>* 一旦堆区中的内存大小超过“-Xmx”所指定的最大内存时，将会抛出OutofMemoryError异常。</li>
</ul>
</li>
<li>通常会将-Xms和-Xmx两个参数配置相同的值，其目的是为了能够在Java垃圾回收机制清理完堆区后不需要重新分隔计算堆区的大小，从而提高性能。</li>
<li>默认情况下:
<ul>
<li>初始内存大小：<code v-pre>物理电脑内存大小/64</code></li>
<li>最大内存大小：<code v-pre>物理电脑内存大小/4</code></li>
</ul>
</li>
</ul>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">HeapSpaceInitial</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="如何验证" tabindex="-1"><a class="header-anchor" href="#如何验证" aria-hidden="true">#</a> 如何验证？</h3>
<p>使用上述代码：HeapSpaceInitial</p>
<blockquote>
<p>jps：查看当前程序运行的进程</p>
</blockquote>
<blockquote>
<p>jstat：JVM在GC的显示信息</p>
</blockquote>
<figure><img src="@source/Java/jvm/part1/images/q-BsvloTprgm1FJzbpXyDsiGHUiV5G8XucWWMPP359M.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<ul>
<li>OC 总量</li>
<li>OU 使用量</li>
<li>EC / EU 伊甸园区</li>
...
<p>初次计算：</p>
<figure><img src="@source/Java/jvm/part1/images/cnnTi09WTD_rXlIob1ynTxn9MKVBh-KXAjEzqHESAGY.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<p>总的加起来是：614400，再除以1024，得到575</p>
<p>但是显示的是：</p>
<figure><img src="@source/Java/jvm/part1/images/UJw5J848UTdqpwpl2F3m3z-fB8Rv5NKMkfYwwJOC5zs.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<p>这是如何计算的？</p>
<p>S0C和S1C选择一个即可，相当于：</p>
<blockquote>
<p>( 25600 + 153600 + 409600 ) / 1024 = 575</p>
</blockquote>
<h2 id="oom举例" tabindex="-1"><a class="header-anchor" href="#oom举例" aria-hidden="true">#</a> OOM举例</h2>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
 * -Xms600m -Xmx600m
 */</span>
...
<li>监控堆内存变化：Old 区域一点一点在变大，直到最后一次垃圾回收器无法回收垃圾时，堆内存被撑爆，抛出 OutOfMemoryError 错误</li>
</ul>
<figure><img src="@source/Java/jvm/part1/images/Z90oAGxEpLhxH0CBTP0jqIDIDZGc2fyS5k9h37p_no8.gif" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<p>最后超过堆空间造成OOM错误</p>
<figure><img src="@source/Java/jvm/part1/images/AU2yQ9wTfybOR29KkNbPHvUxUMn_5R-przkfr7lrz78.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<h1 id="年轻代与老年代" tabindex="-1"><a class="header-anchor" href="#年轻代与老年代" aria-hidden="true">#</a> 年轻代与老年代</h1>
<ul>
<li><strong>存储在JVM中的Java对象可以被划分为两类：</strong>
<ul>
<li>一类是生命周期较短的瞬时对象，这类对象的创建和消亡都非常迅速</li>
<li>另外一类对象的生命周期却非常长，在某些极端的情况下还能够与JVM的生命周期保持一致</li>
</ul>
</li>
<li>Java堆区进一步细分的话，可以划分为<strong>年轻代</strong>（YoungGen）和<strong>老年代</strong>（oldGen）</li>
<li>其中年轻代又可以划分为Eden空间、Survivor0空间和Survivor1空间（有时也叫做from区、to区）</li>
</ul>
<figure><img src="@source/Java/jvm/part1/images/cqNus0vKUjlAduaNYEEUtjxyLhagiC6f_la1d_ZglPI.jpg" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<h2 id="配置新老比例" tabindex="-1"><a class="header-anchor" href="#配置新老比例" aria-hidden="true">#</a> 配置新老比例</h2>
<p>配置新生代与老年代在堆结构的占比（下面这些参数在开发中一般不会调）</p>
<ul>
<li>默认**-XX:NewRatio**=2，表示新生代占1，老年代占2，新生代占整个堆的1/3</li>
<li>可以修改**-XX:NewRatio**=4，表示新生代占1，老年代占4，新生代占整个堆的1/5</li>
<li>当发现在整个项目中，生命周期长的对象偏多，那么就可以通过调整老年代的大小，来进行调优</li>
</ul>
<p>下面这个参数开发中一般不会调：</p>
<figure><img src="@source/Java/jvm/part1/images/gl7PulTEyXi9t998zDd828pDB2mCE3-6eYvs9ZqRhfM.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<h3 id="新生区中的比例" tabindex="-1"><a class="header-anchor" href="#新生区中的比例" aria-hidden="true">#</a> 新生区中的比例</h3>
<ul>
<li>在HotSpot中，Eden空间和另外两个survivor空间缺省所占的比例是8 : 1 : 1</li>
<li>当然开发人员可以通过选项**-XX:SurvivorRatio**调整这个空间比例。比如-XX:SurvivorRatio=8</li>
<li><code v-pre>几乎所有</code>的Java对象都是在Eden区被new出来的。</li>
<li>绝大部分的Java对象的销毁都在新生代进行了（有些大的对象在Eden区无法存储时候，将直接进入老年代）
<ul>
<li>IBM公司的专门研究表明，新生代中80%的对象都是“朝生夕死”的。</li>
</ul>
</li>
<li>可以使用选项&quot;-Xmn&quot;设置新生代最大内存大小，但这个参数一般使用默认值就可以了。</li>
<li>新生区的对象默认生命周期超过 15 ，将进入老年代</li>
</ul>
<figure><img src="@source/Java/jvm/part1/images/if14UlfNEFM6CxKJwBHC430lWvlJ9x2S1oFh3g60cwk.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<p>代码示例：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
 * -Xms600m -Xmx600m
 *
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">EdenSurvivorTest</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"我只是来打个酱油~"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token keyword">try</span> <span class="token punctuation">{</span>
            <span class="token class-name">Thread</span><span class="token punctuation">.</span><span class="token function">sleep</span><span class="token punctuation">(</span><span class="token number">1000000</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token punctuation">}</span> <span class="token keyword">catch</span> <span class="token punctuation">(</span><span class="token class-name">InterruptedException</span> e<span class="token punctuation">)</span> <span class="token punctuation">{</span>
            e<span class="token punctuation">.</span><span class="token function">printStackTrace</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<div class="language-Plain line-numbers-mode" data-ext="Plain"><pre v-pre class="language-Plain"><code>jps
jinfo -flag NewRatios 进程id 
12
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>查看新生区中伊甸园区与幸存者区的比例</li>
</ul>
<div class="language-Plain line-numbers-mode" data-ext="Plain"><pre v-pre class="language-Plain"><code>jps
...
<div class="language-Plain line-numbers-mode" data-ext="Plain"><pre v-pre class="language-Plain"><code>-Xms600m -Xmx600m -XX:NewRatio=2 -XX:SurvivorRatio=8
1
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>新生区中：伊甸园区 : 幸存者 0 区 : 幸存者 1 区 = 8 : 1 : 1</li>
<li>新生区 : 老年区 = 1 : 2</li>
</ul>
<p>思考：设置的600M的堆空间，首先按照新生代：老年代=1:2，新生代就为200M，老年代为400M；再按照新生代8:1:1的方式计算，每个幸存者区应该是20M？这就是因为存在一个自适应的机制（下图的幸存者区为25M，如何解决这个问题？）</p>
<figure><img src="@source/Java/jvm/part1/images/-s2rVc30UvQL2JBJvpmQT88PZnMMUy4nEtqCjp0WIxU.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<blockquote>
<p>加上参数：-XX:-UseAdaptiveSizePolicy ：关闭自适应的内存分配策略</p>
</blockquote>
<p>效果还是和以前一样</p>
<figure><img src="@source/Java/jvm/part1/images/7-22jaKigah4tHvxBIX-qJHna1XbxXKy_JC_B3H5pGw.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<blockquote>
<p>换VM参数为：-XX:SurvivorRatio=8</p>
</blockquote>
<figure><img src="@source/Java/jvm/part1/images/vVb9bpYPmnpsteUhSEIrIfI7XDPaPi9qYZyd9W2pba8.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<figure><img src="@source/Java/jvm/part1/images/cCFpiEe2sRj4WiaVIV8M1cxCjBQfDm_2bU37o5AA8LI.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<p>就可以达到关闭自适应的效果</p>
<h1 id="图解对象分配过程" tabindex="-1"><a class="header-anchor" href="#图解对象分配过程" aria-hidden="true">#</a> 图解对象分配过程</h1>
...
<li>如果再次触发垃圾回收，此时将伊甸园区和幸存者0区进行垃圾回收，剩下的对象就会放到幸存者1区。</li>
<li>如果再次经历垃圾回收，此时会重新放回幸存者0区，接着再去幸存者1区。</li>
<li>啥时候能去养老区呢？可以设置次数。<strong>默认是15次</strong>。可以设置新生区进入养老区的年龄限制，
<ul>
<li>设置 JVM 参数：<strong>-XX:MaxTenuringThreshold</strong>=N 进行设置</li>
</ul>
</li>
<li>在养老区，相对悠闲。当养老区内存不足时，再次触发GC：Major GC，进行养老区的内存清理</li>
<li>若养老区执行了Major GC之后，发现依然无法进行对象的保存，就会产生OOM异常。</li>
</ul>
<h2 id="图解对象分配-重要" tabindex="-1"><a class="header-anchor" href="#图解对象分配-重要" aria-hidden="true">#</a> 图解对象分配(重要)</h2>
<figure><img src="@source/Java/jvm/part1/images/bXj1AaMZ1N4kfaoUSUTWVcZxnniZ_ZgBMBeiTUIrF1k.jpeg" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<p><a href="https://player.bilibili.com/player.html?bvid=1PJ411n7xZ&amp;page=72" target="_blank" rel="noopener noreferrer">webpage<ExternalLinkIcon/></a></p>
<h3 id="分解" tabindex="-1"><a class="header-anchor" href="#分解" aria-hidden="true">#</a> 分解</h3>
<ol>
<li>我们创建的对象，一般都是存放在Eden区的，当我们的Eden区满了后，就会触发GC操作，一般被称为 YGC / Minor GC操作</li>
</ol>
<figure><img src="@source/Java/jvm/part1/images/-rdu3VlMcNQ4i-qfbHHHQkgJ1U5oQMEELHINFawwd2k.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<ol start="2">
<li>当我们进行一次垃圾收集后，红色的对象将会被回收，而绿色的独享还被占用着，存放在S0(Survivor From)区。同时我们给每个对象设置了一个年龄计数器，经过一次回收后还存在的对象，将其年龄加 1。</li>
</ol>
<ul>
<li>同时Eden区继续存放对象，当Eden区再次存满的时候，又会触发一个MinorGC操作，此时GC将会把 Eden和Survivor From中的对象进行一次垃圾收集，把存活的对象放到 Survivor To区，同时让存活的对象年龄 + 1</li>
</ul>
<figure><img src="@source/Java/jvm/part1/images/N9cDFrsI1wDWJQPO_xcCO-lD3NJZz59lfbcJh9s2t-c.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<ol start="3">
<li>我们继续不断的进行对象生成和垃圾回收，当Survivor中的对象的年龄达到15的时候，将会触发一次 Promotion 晋升的操作，也就是将年轻代中的对象晋升到老年代中</li>
</ol>
<figure><img src="@source/Java/jvm/part1/images/3M8xNtOIscxDTOnXfxnUs48NzLLbq9mRC5nNSfX_Vus.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<blockquote>
<p>注意：伊甸园区满了会触发YGC/Minor GC，幸存者区满了不会触发YGC</p>
</blockquote>
<h3 id="特殊情况说明" tabindex="-1"><a class="header-anchor" href="#特殊情况说明" aria-hidden="true">#</a> 特殊情况说明</h3>
<blockquote>
<p>思考：幸存区满了咋办？</p>
</blockquote>
<ul>
<li>特别注意，在Eden区满了的时候，才会触发MinorGC，而<strong>幸存者区满了后，不会触发MinorGC操作</strong></li>
<li>如果Survivor区满了后，将会触发一些特殊的规则，也就是可能直接晋升老年代</li>
</ul>
<blockquote>
<p>对象分配的特殊情况</p>
</blockquote>
<ul>
<li>如果来了一个新对象，先看看 Eden 是否放的下？
<ul>
<li>如果 Eden 放得下，则直接放到 Eden 区</li>
<li>如果 Eden 放不下，则触发 YGC ，执行垃圾回收，看看还能不能放下？放得下最好当然最好咯~~~</li>
</ul>
</li>
<li>将对象放到老年区又有两种情况：
<ul>
<li>如果 Eden 执行了 YGC 还是无法放不下该对象，那没得办法，只能说明是超大对象，只能直接怼到老年代</li>
<li>那万一老年代都放不下，则先触发重 GC ，再看看能不能放下，放得下最好，但如果还是放不下，那只能报 OOM 啦~~~</li>
</ul>
</li>
<li>如果 Eden 区满了，将对象往幸存区拷贝时，发现幸存区放不下啦，那只能便宜了某些新对象，让他们直接晋升至老年区</li>
</ul>
<figure><img src="@source/Java/jvm/part1/images/-ZYwK6WBVSnoJ_cniXSPy8M06fNaTMKbC28e5Zf9dvU.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<h3 id="jvm常用调优工具" tabindex="-1"><a class="header-anchor" href="#jvm常用调优工具" aria-hidden="true">#</a> JVM常用调优工具</h3>
<ul>
<li>JDK命令行</li>
...
<h4 id="jprofiler-基本使用" tabindex="-1"><a class="header-anchor" href="#jprofiler-基本使用" aria-hidden="true">#</a> Jprofiler 基本使用</h4>
<p>在 IDEA 中启动 Jprofiler</p>
<figure><img src="@source/Java/jvm/part1/images/L1MZrcIdwqD7KQ5VsmmDxrCY4U4Mw1BxhbZed2lZjZc.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<ul>
<li>点击 Instrumentation</li>
</ul>
<figure><img src="@source/Java/jvm/part1/images/IHk51nmXSpQsxnjMeCCYKQe6cJK-AX3ZasyKa-p4XDQ.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<h3 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h3>
<ul>
<li>针对幸存者区s0, s1：复制之后有交换，谁空谁是to</li>
<li>关于垃圾回收：频繁在新生区收集，很少在养老区收集，几乎不在永久区/元空间收集</li>
<li>新生代采用复制算法的目的：是为了减少内碎片</li>
</ul>
<h1 id="gc垃圾回收器" tabindex="-1"><a class="header-anchor" href="#gc垃圾回收器" aria-hidden="true">#</a> GC垃圾回收器</h1>
<h2 id="分代收集思想-面试必问" tabindex="-1"><a class="header-anchor" href="#分代收集思想-面试必问" aria-hidden="true">#</a> 分代收集思想(面试必问)</h2>
<blockquote>
...
<p>JVM在进行GC时，并非每次都对上面三个内存( 新生代、老年代；方法区 )区域一起回收的，大部分时候回收的都是指<code v-pre>新生代</code>。针对Hotspot VM的实现，它里面的GC按照回收区域又分为两大种类型：一种是部分收集（Partial GC），一种是整堆收集（FullGC）</p>
<ul>
...
<ul>
<li>目前，<code v-pre>只有CMS GC会有单独收集老年代的行为</code>。</li>
<li>注意，很多时候Major GC会和Full GC混淆使用，需要具体分辨是<strong>老年代回收还是整堆回收</strong>。</li>
</ul>
</li>
...
<h2 id="young-minor-gc" tabindex="-1"><a class="header-anchor" href="#young-minor-gc" aria-hidden="true">#</a> Young/Minor GC</h2>
<blockquote>
...
<figure><img src="@source/Java/jvm/part1/images/3YyIM3EyKSvJ53g6sa-2VKqX3jBdWDKyhp-mFjX2-e4.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<h2 id="major-gc" tabindex="-1"><a class="header-anchor" href="#major-gc" aria-hidden="true">#</a> Major GC</h2>
<blockquote>
...
<p>说明：<code v-pre>Full GC 是开发或调优中尽量要避免的。这样STW时间会短一些</code></p>
<h2 id="gc-日志分析" tabindex="-1"><a class="header-anchor" href="#gc-日志分析" aria-hidden="true">#</a> GC 日志分析</h2>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">GCTest</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        ...
        <span class="token punctuation">}</span> <span class="token keyword">catch</span> <span class="token punctuation">(</span><span class="token class-name">Throwable</span> t<span class="token punctuation">)</span> <span class="token punctuation">{</span>
            ...
            <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"遍历次数为："</span> <span class="token operator">+</span> i<span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token punctuation">}</span>
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>VM参数设置：</p>
...
<figure><img src="@source/Java/jvm/part1/images/q-SgwHuBhDFopoipowGGDQw4kCyJgeIgw3SqsNlVrVI.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<blockquote>
<p>[Full GC (Allocation Failure) [PSYoungGen: 460K-&gt;0K(2560K)] [ParOldGen: 5688K-&gt;4468K(7168K)] 6148K-&gt;4468K(9728K), [Metaspace: 3312K-&gt;3312K(1056768K)], 0.0056846 secs] [Times: user=0.00 sys=0.00, real=0.01 secs]</p>
</blockquote>
<ul>
<li>[PSYoungGen: 460K-&gt;0K(2560K)] ：年轻代总空间为 2560K ，当前占用 460K ，经过垃圾回收后占用 0K</li>
<li>[ParOldGen: 5688K-&gt;4468K(7168K)] ：老年代总空间为 7168K ，当前占用 5688K ，经过垃圾回收后占用 4468K</li>
<li>8102K-&gt;4864K(9728K)：堆内存总空间为 9728K ，当前占用 8102K ，经过垃圾回收后占用 4864K</li>
<li>[Metaspace: 3312K-&gt;3312K(1056768K)] ：元空间总空间为 1056768K ，当前占用 3312K，经过垃圾回收后占用 3312K</li>
<li>0.0050464 secs ：垃圾回收用时 0.0050464 secs</li>
</ul>
<h1 id="堆空间分配思想" tabindex="-1"><a class="header-anchor" href="#堆空间分配思想" aria-hidden="true">#</a> 堆空间分配思想</h1>
<blockquote>
...
<li>老年代：存放新生代中经历多次GC之后仍然存活的对象。</li>
</ul>
</li>
<li>其实不分代完全可以，<strong>分代的唯一理由<strong><strong>就是</strong></strong>优化GC性能</strong>。
<ul>
...
<h1 id="内存分配策略" tabindex="-1"><a class="header-anchor" href="#内存分配策略" aria-hidden="true">#</a> 内存分配策略</h1>
<blockquote>
...
<li>动态对象年龄判断：
<ul>
<li>如果Survivor区中相同年龄的所有对象大小的总和 <code v-pre>大于</code> Survivor空间的一半，年龄大于或等于该年龄的对象可以直接进入老年代，无须等到<code v-pre>MaxTenuringThreshold</code>中要求的年龄。</li>
</ul>
</li>
<li>空间分配担保：
<ul>
<li>-XX:HandlePromotionFailure ，也就是经过Minor GC后，所有的对象都存活，因为Survivor比较小，所以就需要将Survivor无法容纳的对象，存放到老年代中。</li>
</ul>
</li>
</ul>
<blockquote>
...
<p>-Xms60m -Xmx60m -XX:NewRatio=2 -XX:SurvivorRatio=8 -XX:+PrintGCDetails</p>
<blockquote>
<p>结果</p>
</blockquote>
<p>整个过程并没有进行垃圾回收，并且 ParOldGen 区直接占用了 20MB 的空间，说明大对象直接怼到了老年代中</p>
<figure><img src="@source/Java/jvm/part1/images/SBzMAqDvFgz1bOFw2k53PcAe52ICJ6E7vo-raqopZBg.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<h1 id="为对象分配内存-tlab" tabindex="-1"><a class="header-anchor" href="#为对象分配内存-tlab" aria-hidden="true">#</a> 为对象分配内存: TLAB</h1>
<h2 id="为什么有-tlab" tabindex="-1"><a class="header-anchor" href="#为什么有-tlab" aria-hidden="true">#</a> 为什么有 TLAB</h2>
<blockquote>
<p>问题：堆空间都是共享的么？</p>
</blockquote>
...
<h2 id="什么是-tlab" tabindex="-1"><a class="header-anchor" href="#什么是-tlab" aria-hidden="true">#</a> 什么是 TLAB</h2>
<ul>
<li>从内存模型而不是垃圾收集的角度，对Eden区域继续进行划分，<strong>JVM为<strong><strong>每个线程分配了一个私有缓存区域</strong></strong>，它包含在Eden空间内</strong>。</li>
<li>多线程同时分配内存时，<strong>使用TLAB可以<strong><strong>避免一系列的非线程安全问题</strong></strong>，同时还能够提升内存分配的吞吐量</strong>，因此我们可以将这种内存分配方式称之为<strong>快速分配策略</strong>。</li>
<li>据我所知所有OpenJDK衍生出来的JVM都提供了TLAB的设计。</li>
</ul>
<figure><img src="@source/Java/jvm/part1/images/JgX5ocf5_kqRVoPXSwDwUHKncYw20jpVQLJI-qeQ8OE.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<h2 id="tlab-分配过程" tabindex="-1"><a class="header-anchor" href="#tlab-分配过程" aria-hidden="true">#</a> TLAB 分配过程</h2>
<ul>
<li>尽管不是所有的对象实例都能够在TLAB中成功分配内存，但<strong>JVM确实是将TLAB作为内存分配的首选</strong>。</li>
<li>在程序中，开发人员可以通过选项“<strong>-XX:UseTLAB</strong>”设置是否开启TLAB空间。</li>
<li>默认情况下，TLAB空间的内存非常小，<code v-pre>仅占有整个Eden空间的1%</code>，当然我们可以通过选项“<strong>-XX:TLABWasteTargetPercent</strong>”设置TLAB空间所占用Eden空间的百分比大小。</li>
<li>一旦对象在TLAB空间分配内存失败时，JVM就会尝试着通过<strong>使用加锁机制****确保数据操作的原子性</strong>，从而直接在Eden空间中分配内存。</li>
</ul>
<h3 id="测试是否是首选" tabindex="-1"><a class="header-anchor" href="#测试是否是首选" aria-hidden="true">#</a> 测试是否是首选</h3>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
...
<p>运行之后使用jps + jinfo -flag UseTLAB</p>
</blockquote>
<figure><img src="@source/Java/jvm/part1/images/rJIxzrhBni3Ne9DNOhkblkgwr3jGwEJTJk768bI1saY.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<p>可以看到默认开启TLAB</p>
<h3 id="过程详解" tabindex="-1"><a class="header-anchor" href="#过程详解" aria-hidden="true">#</a> 过程详解</h3>
<figure><img src="@source/Java/jvm/part1/images/EaidogFnVxfwVHDT-jRxUSOQYYFuduM76dYbTkkDx9g.jpg" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<ol>
<li>保证当前类要加载过，针对字节码的数据有一个加载过程（图示中的类加载步骤）</li>
<li>判断当前类有没有加载，如果加载了直接进入到伊甸园区</li>
<li>比如要创建一个对象（new Person()）,此时new就会开辟一个堆空间，开辟完之后首先就会在这个独立的线程中放一个TLAB对象，接着设计到对象的赋值就来到对象的实例化（图示TLAB分配 ==&gt; 对象实例化）</li>
<li>如果TLAB分配没有成功，说明这个对象比较大，那么就在公共的伊甸园区进行分配（图示TLAB分配 ==&gt; Eden分配），分配成功就进入到对象的实例化，分配失败说明伊甸园区的空间不是很够，就会进行YGC，然后在进行分配。如果YGC之后还是放不下，进入老年代。</li>
</ol>
<p>总结：</p>
<ol>
<li>堆是共享的，访问需要加锁。而new对象是件很频繁的事情，为了提高效率，所以创建了TLAB区域</li>
<li>这个区域是线程独占，就无须考虑并发问题。</li>
<li>分配对象就先分配到TLAB区域。满了或对象过大，就还分配到外边。</li>
<li>这就要求我们创建对象时候尽量创建小对象。提高效率</li>
</ol>
<h1 id="堆空间参数设置" tabindex="-1"><a class="header-anchor" href="#堆空间参数设置" aria-hidden="true">#</a> 堆空间参数设置</h1>
<h2 id="常用参数设置" tabindex="-1"><a class="header-anchor" href="#常用参数设置" aria-hidden="true">#</a> 常用参数设置</h2>
<blockquote>
<p>官方文档</p>
</blockquote>
<p>大致600多个</p>
<p><a href="https://docs.oracle.com/javase/8/docs/technotes/tools/unix/java.html" target="_blank" rel="noopener noreferrer">webpage<ExternalLinkIcon/></a></p>
<blockquote>
<p>常用参数设置</p>
</blockquote>
<ul>
<li><strong>-XX:+PrintFlagsInitial</strong>：查看所有的参数的默认初始值</li>
<li><strong>-XX:+PrintFlagsFinal</strong>：查看所有的参数的最终值（可能会存在修改，不再是初始值）</li>
<li>-Xms：初始堆空间内存（默认为物理内存的1/64）</li>
<li><strong>-Xmx</strong>：最大堆空间内存（默认为物理内存的1/4）</li>
<li><strong>-Xmn</strong>：设置新生代的大小（初始值及最大值）</li>
<li><strong>-XX:NewRatio</strong>：配置新生代与老年代在堆结构的占比</li>
<li><strong>-XX:SurvivorRatio</strong>：设置新生代中Eden和S0/S1空间的比例</li>
<li><strong>-XX:MaxTenuringThreshold</strong>：设置新生代垃圾的最大年龄</li>
<li><strong>-XX:+PrintGCDetails</strong>：输出详细的GC处理日志</li>
<li><strong>-XX:+PrintGC</strong> 或 -verbose:gc ：打印gc简要信息</li>
<li><strong>-XX:HandlePromotionFalilure</strong>：是否设置空间分配担保</li>
</ul>
<h2 id="空间分配担保" tabindex="-1"><a class="header-anchor" href="#空间分配担保" aria-hidden="true">#</a> 空间分配担保</h2>
<p><strong>在发生Minor GC之前，<strong><strong>虚拟机会检查老年代最大可用的连续空间是否大于新生代所有对象的总空间</strong></strong>。</strong></p>
<ul>
<li>如果大于，则此次Minor GC是安全的</li>
<li>如果小于，则虚拟机会查看**-XX:HandlePromotionFailure**设置值是否允许担保失败。
<ul>
<li>如果HandlePromotionFailure=true，那么会继续检查老年代最大可用连续空间是否大于历次晋升到老年代的对象的平均大小
<ul>
...
<ul>
<li>在JDK6 Update 24之后 (JDK 7)，HandlePromotionFailure参数不会再影响到虚拟机的空间分配担保策略，观察openJDK中的源码变化，虽然源码中还定义了HandlePromotionFailure参数，但是在代码中已经不会再使用它。</li>
<li>JDK6 Update 24之后的规则变为只要老年代的连续空间<code v-pre>大于</code>新生代对象总大小或者历次晋升的平均大小就会进行Minor GC，否则将进行Full GC。即 HandlePromotionFailure=true</li>
</ul>
<blockquote>
<p>代码示例</p>
</blockquote>
...
<p>问题：如果伊甸园区设置的不够大，幸存者区设置的比较大怎么办？</p>
</blockquote>
<p>此时YGC出现的频率就比较高，就会影响用户进程导致STW（总体时间）变多</p>
<h1 id="面试问题" tabindex="-1"><a class="header-anchor" href="#面试问题" aria-hidden="true">#</a> 面试问题</h1>
<h2 id="堆是分配对象存储的唯一选择吗" tabindex="-1"><a class="header-anchor" href="#堆是分配对象存储的唯一选择吗" aria-hidden="true">#</a> 堆是分配对象存储的唯一选择吗？</h2>
<p><strong>在《深入理解Java虚拟机》中关于Java堆内存有这样一段描述：</strong></p>
<ul>
<li>随着JIT编译期的发展与<code v-pre>逃逸分析技术</code>逐渐成熟，<strong>栈上分配、标量替换</strong>优化技术将会导致一些微妙的变化，所有的对象都分配到堆上也渐渐变得不那么“绝对”了。</li>
<li>在Java虚拟机中，对象是在Java堆中分配内存的，这是一个普遍的常识。但是，有一种特殊情况，那就是<code v-pre>如果经过逃逸分析（Escape Analysis）后发现，一个对象并没有逃逸出方法的话，那么就可能被优化成栈上分配</code>。这样就无需在堆上分配内存，也无须进行垃圾回收了。这也是最常见的堆外存储技术。</li>
<li>此外，前面提到的基于OpenJDK深度定制的TaoBao VM( 淘宝虚拟机 )，其中创新的GCIH（GC invisible heap）技术实现off-heap，将生命周期较长的Java对象从heap中移至heap外，并且GC不能管理GCIH内部的Java对象，以此达到降低GC的回收频率和提升GC的回收效率的目的。</li>
</ul>
<h2 id="逃逸分析" tabindex="-1"><a class="header-anchor" href="#逃逸分析" aria-hidden="true">#</a> 逃逸分析</h2>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>下面代码中的 StringBuffer sb 发生了逃逸（因为这个StringBuffer在方法外有可能被调用），由此可以进一步拓展，【栈上分配大致就是只在方法内部用，用完就丢】</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果想要StringBuffer sb不发生逃逸，可以这样写</p>
...
<li>逃逸分析的举例</li>
<li><strong>如何快速的判断是否发生了逃逸分析，大家就看new的对象实体是否有可能在方法外被调用</strong></li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
 * 逃逸分析
 *
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">EscapeAnalysis</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">useEscapeAnalysis1</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
        <span class="token class-name">EscapeAnalysis</span> e <span class="token operator">=</span> <span class="token function">getInstance</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">//这个e对象，本身就是从外面的方法逃逸进来的</span>
        <span class="token comment">//getInstance().xxx()同样会发生逃逸</span>
    <span class="token punctuation">}</span>

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="参数设置" tabindex="-1"><a class="header-anchor" href="#参数设置" aria-hidden="true">#</a> 参数设置</h3>
<ul>
<li><strong>在JDK 1.7 版本之后，HotSpot中默认就已经开启了逃逸分析</strong></li>
...
<h2 id="栈上分配" tabindex="-1"><a class="header-anchor" href="#栈上分配" aria-hidden="true">#</a> 栈上分配</h2>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当没有开启逃逸分析的时候</p>
<blockquote>
<p>-Xmx256m -Xms256m -XX:-DoEscapeAnalysis -XX:+PrintGCDetails</p>
</blockquote>
<figure><img src="@source/Java/jvm/part1/images/DSBTBgPy4Y1yJj-lQjP_9sVAR-R2YyLFkNElDYMsaL0.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
...
花费的时间为： <span class="token number">42</span> ms
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>开启了逃逸分析后</p>
<blockquote>
<p>-Xmx256m -Xms256m -XX:+DoEscapeAnalysis -XX:+PrintGCDetails</p>
</blockquote>
<figure><img src="@source/Java/jvm/part1/images/fVP-1ufq7Z62dCEY3Iz2Lj3xZfqhZiXa05wJlnmnXqg.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>花费的时间为： <span class="token number">4</span> ms
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="同步省略" tabindex="-1"><a class="header-anchor" href="#同步省略" aria-hidden="true">#</a> 同步省略</h2>
<ul>
<li><strong>线程同步的代价是相当高的，同步的后果是降低并发性和性能</strong>。</li>
<li>在动态编译同步块的时候，JIT编译器可以借助<code v-pre>逃逸分析</code>来判断同步块所使用的锁对象是否只能够被一个线程访问而没有被发布到其他线程。</li>
<li>如果没有，那么JIT编译器在编译这个同步块的时候就会取消对这部分代码的同步。这样就能大大提高并发性和性能。这个<strong>取消同步的过程就叫同步省略，也叫****锁消除</strong>。</li>
<li>例如下面的智障代码，根本起不到锁的作用</li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">f</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>代码中对hellis这个对象加锁，但是hellis对象的生命周期只在f( )方法中，并不会被其他线程所访问到，所以在JIT编译阶段就会被优化掉，优化成：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">f</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  	<span class="token class-name">Object</span> hellis <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Object</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
		<span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span>hellis<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
 ...
 * <span class="token keyword">@create</span> 2020-11-27 7:01 下午
 */</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">SynchronizedTest</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意：字节码文件中并没有进行优化，可以看到加锁和释放锁的操作依然存在，<strong>同步省略操作是在解释运行时发生的</strong></p>
<p>（同步操作是下图中橙色标志）</p>
<figure><img src="@source/Java/jvm/part1/images/py6qZbSRhDZ6tZhg73idSYxgBXGOyXPuU2Nuz30D81M.png" alt="image" tabindex="0" loading="lazy"><figcaption>image</figcaption></figure>
<h2 id="分离对象或标量替换" tabindex="-1"><a class="header-anchor" href="#分离对象或标量替换" aria-hidden="true">#</a> 分离对象或标量替换</h2>
<ul>
<li><strong>标量（scalar）是指一个无法再分解成更小的数据的数据。Java中的原始数据类型就是标量</strong>。</li>
<li>相对的，那些还可以分解的数据叫做聚合量（Aggregate），Java中的对象就是聚合量，因为他可以分解成其他聚合量和标量。</li>
<li>在JIT阶段，如果经过逃逸分析，发现一个对象不会被外界访问的话，那么经过JIT优化，就会<strong>把这个对象拆解成若干个其中包含的若干个成员变量来代替。这个过程就是标量替换</strong></li>
</ul>
<blockquote>
<p>代码举例</p>
</blockquote>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ScalarReplace</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">alloc</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token class-name">User</span> u <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">User</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span><span class="token comment">//未发生逃逸</span>
...
花费的时间为： <span class="token number">50</span> ms
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote>
<p>开启标量替换，结果</p>
</blockquote>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>花费的时间为： <span class="token number">5</span> ms
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>结论：</strong></p>
<ul>
...
<h3 id="逃逸分析参数设置总结" tabindex="-1"><a class="header-anchor" href="#逃逸分析参数设置总结" aria-hidden="true">#</a> 逃逸分析参数设置总结</h3>
<ul>
<li>上述代码在主函数中调用了1亿次alloc( )方法，进行对象创建</li>
<li>由于User对象实例需要占据约16字节的空间，因此累计分配空间达到将近1.5GB。</li>
<li>如果堆空间小于这个值，就必然会发生GC。使用如下参数运行上述代码：</li>
</ul>
<blockquote>
...
<h3 id="逃逸分析的不足" tabindex="-1"><a class="header-anchor" href="#逃逸分析的不足" aria-hidden="true">#</a> 逃逸分析的不足</h3>
<ul>
<li>关于逃逸分析的论文在1999年就已经发表了，但直到JDK1.6才有实现，而且这项技术到如今也并不是十分成熟的。</li>
<li>其根本原因就是无法保证逃逸分析的性能消耗一定能高于他的消耗。虽然经过逃逸分析可以做标量替换、栈上分配、和锁消除。但是逃逸分析自身也是需要进行一系列复杂的分析的，这其实也是一个相对耗时的过程。一个极端的例子，就是经过逃逸分析之后，发现没有一个对象是不逃逸的。那这个逃逸分析的过程就白白浪费掉了。</li>
<li>虽然这项技术并不十分成熟，但是它也是即时编译器优化技术中一个十分重要的手段。注意到有一些观点，认为通过逃逸分析，JVM会在栈上分配那些不会逃逸的对象，这在理论上是可行的，但是取决于JVM设计者的选择。</li>
<li>据我所知，<strong>Oracle Hotspot JVM中并未这么做</strong>，这一点在逃逸分析相关的文档里已经说明，所以可以明确所有的对象实例都是创建在堆上。</li>
<li><strong>Oracle Hotspot JVM</strong>是通过标量替换实现逃逸分析的</li>
<li>目前很多书籍还是基于JDK7以前的版本，JDK已经发生了很大变化，intern字符串的缓存和静态变量曾经都被分配在永久代上，而永久代已经被元数据区取代。但是<strong>intern字符串缓存和静态变量并不是被转移到元数据区，而是直接在堆上分配</strong>，所以这一点同样符合前面一点的结论：<strong>对象实例都是分配在堆上</strong>。</li>
</ul>
<h1 id="堆总结" tabindex="-1"><a class="header-anchor" href="#堆总结" aria-hidden="true">#</a> 堆总结</h1>
<ul>
...
<li>当GC发生在老年代时则被称为Major GC（主要是老年代）或者Full GC（回收堆、方法区）</li>

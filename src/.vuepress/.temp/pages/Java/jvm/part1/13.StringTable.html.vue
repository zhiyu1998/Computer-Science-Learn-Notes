...
<h1 id="string的基本特性" tabindex="-1"><a class="header-anchor" href="#string的基本特性" aria-hidden="true">#</a> String的基本特性</h1>
<ul>
<li>
<p>String：字符串，使用一对&quot; &quot;引起来表示</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">String</span> s1 <span class="token operator">=</span> “baidu”<span class="token punctuation">;</span> <span class="token comment">//字面量的定义方式</span>
...
<h2 id="string在jdk9中存储结构变更" tabindex="-1"><a class="header-anchor" href="#string在jdk9中存储结构变更" aria-hidden="true">#</a> String在jdk9中存储结构变更</h2>
<p>官网地址：<a href="http://openjdk.java.net/jeps/254" target="_blank" rel="noopener noreferrer">JEP 254: Compact Strings (java.net)<ExternalLinkIcon/></a></p>
<blockquote>
<p>Motivation</p>
<p>The current implementation of the <code v-pre>String</code> class stores characters in a <code v-pre>char</code> array, using two bytes (sixteen bits) for each character. Data gathered from many different applications indicates that strings are a major  component of heap usage and, moreover, that most <code v-pre>String</code> objects contain only Latin-1 characters. Such characters require only  one byte of storage, hence half of the space in the internal <code v-pre>char</code> arrays of such <code v-pre>String</code> objects is going unused.</p>
<p>Description</p>
<p>We propose to change the internal representation of the <code v-pre>String</code> class from a UTF-16 <code v-pre>char</code> array to a <code v-pre>byte</code> array plus an encoding-flag field. The new <code v-pre>String</code> class will store characters encoded either as ISO-8859-1/Latin-1 (one  byte per character), or as UTF-16 (two bytes per character), based upon  the contents of the string. The encoding flag will indicate which  encoding is used.</p>
<p>String-related classes such as <code v-pre>AbstractStringBuilder</code>, <code v-pre>StringBuilder</code>, and <code v-pre>StringBuffer</code> will be updated to use the same representation, as will the HotSpot VM’s intrinsic string operations.</p>
...
<p>该类的当前实现<code v-pre>String</code>将字符存储在一个 <code v-pre>char</code>数组中，每个字符使用两个字节（十六位）。从许多不同应用程序收集的数据表明，字符串是堆使用的主要组成部分，而且大多数<code v-pre>String</code>对象仅包含 Latin-1 字符。此类字符仅需要一个字节的存储空间，因此此类对象的内部<code v-pre>char</code>数组中的 一半空间未使用。<code v-pre>String</code></p>
<p><strong>描述</strong></p>
<p>我们建议将<code v-pre>String</code>类的内部表示从 UTF-16<code v-pre>char</code>数组更改为<code v-pre>byte</code>数组加上编码标志字段。新<code v-pre>String</code>类将根据字符串的内容存储编码为 ISO-8859-1/Latin-1（每个字符一个字节）或 UTF-16（每个字符两个字节）的字符。编码标志将指示使用哪种编码。</p>
<p>与字符串相关的类（例如<code v-pre>AbstractStringBuilder</code>、<code v-pre>StringBuilder</code>和 ）<code v-pre>StringBuffer</code>将被更新为使用相同的表示形式，HotSpot VM 的内在字符串操作也是如此。</p>
<p>这纯粹是一个实现更改，对现有的公共接口没有任何更改。没有计划添加任何新的公共 API 或其他接口。</p>
<p>迄今为止完成的原型设计工作证实了内存占用的预期减少、GC 活动的大幅减少以及在某些极端情况下的轻微性能回归。</p>
</blockquote>
<blockquote>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="string的基本特性-1" tabindex="-1"><a class="header-anchor" href="#string的基本特性-1" aria-hidden="true">#</a> String的基本特性</h2>
<ul>
...
<li>使用<code v-pre>-XX:StringTablesize</code>可设置StringTable的长度</li>
<li>在JDK6中StringTable是固定的，就是1009的长度，所以如果常量池中的字符串过多就会导致效率下降很快。<code v-pre>StringTablesize</code>设置没有要求</li>
<li>在JDK7中，StringTable的长度默认值是60013，<code v-pre>StringTablesize</code>设置没有要求</li>
<li>在<u><em>JDK8开始，设置StringTable长度的话，1009是可以设置的最小值</em></u></li>
</ul>
</li>
</ul>
<blockquote>
<p>代码示例：体现 String 的不可变性</p>
</blockquote>
...
<p>在JDK8开始，设置StringTable长度的话，1009是可以设置的最小值</p>
</blockquote>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token comment">//测试StringTableSize参数</span>
<span class="token comment">//        System.out.println("我来打个酱油");</span>
...
<li>默认什么都不设置，运行</li>
<li>命令行输入指令查看 StringTable 的长度</li>
</ul>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>jps
jinfo -flag StringTableSize
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="@source/Java/jvm/part1/images/image-20220303210426840.png" alt="image-20220303210426840" tabindex="0" loading="lazy"><figcaption>image-20220303210426840</figcaption></figure>
<ul>
<li>可以看到默认长度就是60013</li>
<li>设置JVM参数</li>
</ul>
<blockquote>
<p>-XX:StringTableSize=10</p>
</blockquote>
<p>发生报错</p>
<figure><img src="@source/Java/jvm/part1/images/image-20220303210521297.png" alt="image-20220303210521297" tabindex="0" loading="lazy"><figcaption>image-20220303210521297</figcaption></figure>
<p>StringTable 大小为 10 无效；必须介于 1009 和 2305843009213693951 之间</p>
<blockquote>
<p>String 笔试题：考察对String不可变性的认识</p>
</blockquote>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">StringExer</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>再将这 10万 个字符串存入字符串常量池中，测试不同的StringTable对性能的影响</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
...
<li>设置 StringTable 大小为默认最小值 1009</li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token operator">-</span><span class="token constant">XX</span><span class="token operator">:</span><span class="token class-name">StringTableSize</span><span class="token operator">=</span><span class="token number">1009</span>
<span class="token number">1</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>结果为：206ms</li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>花费的时间为：<span class="token number">206</span>
<span class="token number">1</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>再将 StringTable 大小设置为 100009</li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token operator">-</span><span class="token constant">XX</span><span class="token operator">:</span><span class="token class-name">StringTableSize</span><span class="token operator">=</span><span class="token number">100009</span>
<span class="token number">1</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>结果为：51ms</li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>花费的时间为：<span class="token number">51</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h1 id="string的内存分配" tabindex="-1"><a class="header-anchor" href="#string的内存分配" aria-hidden="true">#</a> String的内存分配</h1>
<ul>
...
<ul>
<li>比如：<code v-pre>String info = “cn.bing.com”</code>;</li>
</ul>
</li>
...
<li>字符串常量池概念原本使用得比较多，但是这个改动使得我们有足够的理由让我们重新考虑在Java 7中使用<code v-pre>String.intern()</code></li>
</ul>
</li>
<li>Java8元空间，字符串常量在堆空间中</li>
</ul>
<figure><img src="@source/Java/jvm/part1/images/image-20220227161025841.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<figure><img src="@source/Java/jvm/part1/images/image-20220227161034169.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<figure><img src="@source/Java/jvm/part1/images/image-20220227161042271.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<blockquote>
...
<p>官网地址：<a href="https://www.oracle.com/java/technologies/javase/jdk7-relnotes.html#jdk7changes" target="_blank" rel="noopener noreferrer">Java SE 7 Features and Enhancements (oracle.com)<ExternalLinkIcon/></a></p>
<blockquote>
<p><strong>Synopsis:</strong> In JDK 7, interned strings are no longer  allocated in the permanent generation of the Java heap, but are instead  allocated in the main part of the Java heap (known as the young and old  generations), along with the other objects created by the application.  This change will result in more data residing in the main Java heap, and less data in the permanent generation, and thus may require heap sizes  to be adjusted. Most applications will see only relatively small  differences in heap usage due to this change, but larger applications  that load many classes or make heavy use of the <code v-pre>String.intern()</code> method will see more significant differences.</p>
</blockquote>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以看到OOM是发生在堆空间中，所以字符串常量池在JDK8中确实是存在堆空间中的</p>
<figure><img src="@source/Java/jvm/part1/images/image-20220303212519952.png" alt="image-20220303212519952" tabindex="0" loading="lazy"><figcaption>image-20220303212519952</figcaption></figure>
<h1 id="string-基本操作" tabindex="-1"><a class="header-anchor" href="#string-基本操作" aria-hidden="true">#</a> String 基本操作</h1>
<blockquote>
<p>Java语言规范里要求完全相同的字符串字面量，应该包含同样的Unicode字符序列（包含同一份码点序列的常量），并且必须是指向同一个String类实例。</p>
</blockquote>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">StringTest4</span> <span class="token punctuation">{</span>

    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span><span class="token comment">//1230</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"1"</span><span class="token punctuation">)</span><span class="token punctuation">;</span><span class="token comment">//1231</span>
        ...
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"10"</span><span class="token punctuation">)</span><span class="token punctuation">;</span><span class="token comment">//1240</span>
        <span class="token comment">//如下的字符串"1" 到 "10"不会再次加载</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"1"</span><span class="token punctuation">)</span><span class="token punctuation">;</span><span class="token comment">//1241</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"2"</span><span class="token punctuation">)</span><span class="token punctuation">;</span><span class="token comment">//1241</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"3"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"4"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"5"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"6"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        ...
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"8"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"9"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"10"</span><span class="token punctuation">)</span><span class="token punctuation">;</span><span class="token comment">//1241</span>
    <span class="token punctuation">}</span>

<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>对一些代码进行打断点操作</li>
<li>初始化有 2123 个字符串</li>
</ul>
<figure><img src="@source/Java/jvm/part1/images/image-20220304110839064.png" alt="image-20220304110839064" tabindex="0" loading="lazy"><figcaption>image-20220304110839064</figcaption></figure>
<p>执行字符串”1”，可以发现字符串数量变成了2124个</p>
<figure><img src="@source/Java/jvm/part1/images/image-20220304110904919.png" alt="image-20220304110904919" tabindex="0" loading="lazy"><figcaption>image-20220304110904919</figcaption></figure>
<p>执行字符串”10”，可以发现字符串数量变成了2133个</p>
<figure><img src="@source/Java/jvm/part1/images/image-20220304110930069.png" alt="image-20220304110930069" tabindex="0" loading="lazy"><figcaption>image-20220304110930069</figcaption></figure>
<p>下面相同的字符串都在字符串常量池加载过一次了，所以下面相同的字符串都不会再被加载了</p>
<figure><img src="@source/Java/jvm/part1/images/image-20220304111124367.png" alt="image-20220304111124367" tabindex="0" loading="lazy"><figcaption>image-20220304111124367</figcaption></figure>
<blockquote>
<p>代码示例2</p>
</blockquote>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">Memory</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="@source/Java/jvm/part1/images/8f8c491a8a4e961805a4df04f2291182.png" alt="Untitled" tabindex="0" loading="lazy"><figcaption>Untitled</figcaption></figure>
<p>上面图片的局部变量表还缺少几个参数，下面列出正确的局部变量表数量</p>
<ul>
<li>注意这里是非静态方法所以第一个位置放得是this，第二个才是param</li>
</ul>
<figure><img src="@source/Java/jvm/part1/images/image-20220304111646344.png" alt="image-20220304111646344" tabindex="0" loading="lazy"><figcaption>image-20220304111646344</figcaption></figure>
<p>全过程解析：</p>
<ol>
<li>main方法的param对应的是mem这个变量</li>
<li>把这个param给了字符串str，然后记录在字符串常量池中（当前对象类型和存储地址）</li>
</ol>
<p>注：这里的toString调用的是Object的，底层通过StringBuilder进行拼接，会在堆内存中new一个String对象，因此这时的字符串常量池没字符串对象。str指向堆String对象</p>
<h1 id="字符串拼接操作" tabindex="-1"><a class="header-anchor" href="#字符串拼接操作" aria-hidden="true">#</a> 字符串拼接操作</h1>
<ul>
<li>常量与常量的拼接结果在常量池，原理是编译期优化</li>
<li>常量池中不会存在相同内容的变量</li>
<li>只要其中有一个是变量，结果就在堆中。变量拼接的原理是<code v-pre>StringBuilder</code></li>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过编译后查看class文件可以看到</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">test1</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token class-name">String</span> s1 <span class="token operator">=</span> <span class="token string">"abc"</span><span class="token punctuation">;</span>
    <span class="token class-name">String</span> s2 <span class="token operator">=</span> <span class="token string">"abc"</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>再次查看jclasslib的情况</p>
<ul>
<li>可以看到ldc是从字符串常量池中取出的，放入局部变量表中，不仅是第二个，第一个字符串也是从常量池取出，所以显然是值一样</li>
</ul>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code> <span class="token number">0</span> ldc <span class="token comment">#2 &lt;abc></span>
 <span class="token number">2</span> astore_1
 <span class="token number">3</span> ldc <span class="token comment">#2 &lt;abc></span>
 <span class="token number">5</span> astore_2
 <span class="token number">6</span> getstatic <span class="token comment">#3 &lt;java/lang/System.out : Ljava/io/PrintStream;></span>
...
<span class="token number">15</span> goto <span class="token number">19</span> <span class="token punctuation">(</span><span class="token operator">+</span><span class="token number">4</span><span class="token punctuation">)</span>
<span class="token number">18</span> iconst_0
<span class="token number">19</span> invokevirtual <span class="token comment">#4 &lt;java/io/PrintStream.println : (Z)V></span>
<span class="token number">22</span> getstatic <span class="token comment">#3 &lt;java/lang/System.out : Ljava/io/PrintStream;></span>
<span class="token number">25</span> aload_1
<span class="token number">26</span> aload_2
<span class="token number">27</span> invokevirtual <span class="token comment">#5 &lt;java/lang/String.equals : (Ljava/lang/Object;)Z></span>
<span class="token number">30</span> invokevirtual <span class="token comment">#4 &lt;java/io/PrintStream.println : (Z)V></span>
<span class="token number">33</span> <span class="token keyword">return</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote>
<p>代码示例2</p>
</blockquote>
<p>这就解释了：只要其中有一个是变量，结果就在堆中。变量拼接的原理是<code v-pre>StringBuilder</code></p>
<ul>
<li>如果拼接符号的前后出现了变量，则相当于在堆空间中new String()</li>
<li>intern
<ul>
<li>判断字符串常量池中是否存在javaEEhadoop值，如果存在，则返回常量池中javaEEhadoop的地址</li>
<li>如果字符串常量池中不存在javaEEhadoop，则在常量池中加载一份javaEEhadoop，并返回此对象的地址。</li>
</ul>
</li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<p>比如s1，它在栈结构里面，里面有test3的栈帧，栈帧里面有一个局部变量表是一个数组，索引为0是this，索引为1是s1，指向的就是堆空间里面的常量池中的'a'</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">test3</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>反编译字节码文件</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code> <span class="token number">0</span> ldc <span class="token comment">#14 &lt;a></span>
 <span class="token number">2</span> astore_1
 <span class="token number">3</span> ldc <span class="token comment">#15 &lt;b></span>
 <span class="token number">5</span> astore_2
 <span class="token number">6</span> ldc <span class="token comment">#16 &lt;ab></span>
 <span class="token number">8</span> astore_3
 <span class="token number">9</span> new <span class="token comment">#9 &lt;java/lang/StringBuilder></span>
<span class="token number">12</span> dup
<span class="token number">13</span> invokespecial <span class="token comment">#10 &lt;java/lang/StringBuilder.&lt;init> : ()V></span>
<span class="token number">16</span> aload_1
<span class="token number">17</span> invokevirtual <span class="token comment">#11 &lt;java/lang/StringBuilder.append : (Ljava/lang/String;)Ljava/lang/StringBuilder;></span>
<span class="token number">20</span> aload_2
<span class="token number">21</span> invokevirtual <span class="token comment">#11 &lt;java/lang/StringBuilder.append : (Ljava/lang/String;)Ljava/lang/StringBuilder;></span>
<span class="token number">24</span> invokevirtual <span class="token comment">#12 &lt;java/lang/StringBuilder.toString : ()Ljava/lang/String;></span>
<span class="token number">27</span> astore <span class="token number">4</span>
<span class="token number">29</span> getstatic <span class="token comment">#3 &lt;java/lang/System.out : Ljava/io/PrintStream;></span>
...
<span class="token number">39</span> goto <span class="token number">43</span> <span class="token punctuation">(</span><span class="token operator">+</span><span class="token number">4</span><span class="token punctuation">)</span>
<span class="token number">42</span> iconst_0
<span class="token number">43</span> invokevirtual <span class="token comment">#4 &lt;java/io/PrintStream.println : (Z)V></span>
<span class="token number">46</span> <span class="token keyword">return</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="@source/Java/jvm/part1/images/478f3f95a84314dcb2b9b906ed71d698.png" alt="Untitled" tabindex="0" loading="lazy"><figcaption>Untitled</figcaption></figure>
<p>可以看到 String s4 = s1 + s2; 相当于new了一个 StringBuilder，然后使用append拼接 s1 和 s2  字符串，最后再使用toString( )方法约等于new  了一个String对象存放在堆中，这里要和字符串常量池区分开，s3存放在字符串常量池中，s4存放在堆中，所以 s3 不等于 s4</p>
<blockquote>
<p>知识补充：在 JDK 5 之后，使用的是 StringBuilder，在 JDK 5 之前使用的是 StringBuffer</p>
</blockquote>
<table>
<thead>
<tr>
...
<ol>
<li>字符串拼接操作不一定使用的是StringBuilder
<ol>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>		<span class="token comment">/*
    ...
    <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">test4</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
        ...
        <span class="token class-name">String</span> s3 <span class="token operator">=</span> <span class="token string">"ab"</span><span class="token punctuation">;</span>
        <span class="token class-name">String</span> s4 <span class="token operator">=</span> s1 <span class="token operator">+</span> s2<span class="token punctuation">;</span> <span class="token comment">//s4:常量</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span>s3 <span class="token operator">==</span> s4<span class="token punctuation">)</span><span class="token punctuation">;</span><span class="token comment">//true</span>
    <span class="token punctuation">}</span>

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>注意，我们左右两边如果是变量的话，就是需要 new StringBuilder 进行拼接，但是如果使用的是 final  修饰，则是从常量池中获取。所以说拼接符号左右两边都是字符串常量或常量引用 则仍然使用编译器优化。也就是说被 final  修饰的变量，将会变成常量，类和方法将不能被继承。
<ul>
...
<p>通过StringBuilder的append()的方式添加字符串的效率要远高于使用String的字符串拼接方式</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">/*
    ...
    */</span>
    ...
    <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">test6</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
        ...
        <span class="token function">method1</span><span class="token punctuation">(</span><span class="token number">100000</span><span class="token punctuation">)</span><span class="token punctuation">;</span><span class="token comment">// 3375</span>
<span class="token comment">//        method2(100000);// 5</span>
...
<span class="token comment">//        System.out.println(src);</span>
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="intern-的使用" tabindex="-1"><a class="header-anchor" href="#intern-的使用" aria-hidden="true">#</a> intern( )的使用</h1>
<blockquote>
<p>官方API文档中的解释</p>
<p>public String intern( )</p>
<p>Returns a canonical representation for the string object.</p>
<p>A pool of strings, initially empty, is maintained privately by the class <code v-pre>String</code>.</p>
<p>When the intern method is invoked, if the pool already contains a string equal to this <code v-pre>String</code> object as determined by the <code v-pre>[equals(Object)] method, then the string from the pool is returned. Otherwise, this </code>String<code v-pre>object is added to the pool and a reference to this</code>String` object is returned.</p>
<p>It follows that for any two strings <code v-pre>s</code> and <code v-pre>t</code>, <code v-pre>s.intern() == t.intern()</code> is <code v-pre>true</code> if and only if <code v-pre>s.equals(t)</code> is <code v-pre>true</code>.</p>
...
<ul>
<li>**Returns:**a string that has the same contents as this string, but is guaranteed to be from a pool of unique strings.</li>
</ul>
<p>中文：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>public String intern()
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>返回字符串对象的规范表示。</p>
<p>最初为空的字符串池由<code v-pre>String</code>类<code v-pre>String</code> 。</p>
<p>当调用intern方法时，如果池已经包含与<code v-pre>equals(Object)</code>方法确定的相当于此<code v-pre>String</code>对象的字符串，则返回来自池的字符串。 否则，此<code v-pre>String</code>对象将添加到池中，并返回对此<code v-pre>String</code>对象的引用。</p>
<p>由此可见，对于任何两个字符串<code v-pre>s</code>和<code v-pre>t</code> ， <code v-pre>s.intern() == t.intern()</code>是<code v-pre>true</code>当且仅当<code v-pre>s.equals(t)</code>是<code v-pre>true</code> 。</p>
<p>所有文字字符串和字符串值常量表达式都被实体化。 字符串文字在The Java™ Language Specification的 3.10.5节中定义。</p>
<ul>
<li>
<p><strong>结果</strong></p>
<p>一个字符串与该字符串具有相同的内容，但保证来自一个唯一的字符串池。</p>
</li>
</ul>
</blockquote>
<blockquote>
...
<ul>
<li><code v-pre>intern()</code> 是一个 native 方法，调用的是底层 C 的方法。</li>
</ul>
...
<li>如果不是用双引号声明的String对象，可以使用String提供的intern方法，它会从字符串常量池中查询当前字符串是否存在，若不存在就会将当前字符串放入常量池中。</li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">String</span> myInfo <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token function">string</span><span class="token punctuation">(</span><span class="token string">"I love alibaba"</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">intern</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token number">1</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><ul>
 ...
 */</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="@source/Java/jvm/part1/images/f0e813156bdcaddaff24b9e7a9192714.png" alt="Untitled" tabindex="0" loading="lazy"><figcaption>Untitled</figcaption></figure>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">StringNewTest</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>转换成字节码来查看</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code> <span class="token number">0</span> new <span class="token comment">#2 &lt;java/lang/String></span>
 <span class="token number">3</span> dup
 <span class="token number">4</span> ldc <span class="token comment">#3 &lt;ab></span>
 <span class="token number">6</span> invokespecial <span class="token comment">#4 &lt;java/lang/String.&lt;init> : (Ljava/lang/String;)V></span>
 <span class="token number">9</span> astore_1
<span class="token number">10</span> <span class="token keyword">return</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里面就是两个对象</p>
<ul>
<li>一个对象是：new 关键字在堆空间中创建 （new #2 <code v-pre>&lt;java/lang/String&gt;</code>）</li>
<li>另一个对象：字符串常量池中的对象*“ab”* （ldc #3 <code v-pre>&lt;ab&gt;</code>）</li>
</ul>
<blockquote>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">StringNewTest</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>转换成字节码来查看</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code> <span class="token number">0</span> new <span class="token comment">#2 &lt;java/lang/StringBuilder></span>
 <span class="token number">3</span> dup
 <span class="token number">4</span> invokespecial <span class="token comment">#3 &lt;java/lang/StringBuilder.&lt;init> : ()V></span>
 <span class="token number">7</span> new <span class="token comment">#4 &lt;java/lang/String></span>
<span class="token number">10</span> dup
<span class="token number">11</span> ldc <span class="token comment">#5 &lt;a></span>
<span class="token number">13</span> invokespecial <span class="token comment">#6 &lt;java/lang/String.&lt;init> : (Ljava/lang/String;)V></span>
<span class="token number">16</span> invokevirtual <span class="token comment">#7 &lt;java/lang/StringBuilder.append : (Ljava/lang/String;)Ljava/lang/StringBuilder;></span>
<span class="token number">19</span> new <span class="token comment">#4 &lt;java/lang/String></span>
<span class="token number">22</span> dup
<span class="token number">23</span> ldc <span class="token comment">#8 &lt;b></span>
<span class="token number">25</span> invokespecial <span class="token comment">#6 &lt;java/lang/String.&lt;init> : (Ljava/lang/String;)V></span>
<span class="token number">28</span> invokevirtual <span class="token comment">#7 &lt;java/lang/StringBuilder.append : (Ljava/lang/String;)Ljava/lang/StringBuilder;></span>
<span class="token number">31</span> invokevirtual <span class="token comment">#9 &lt;java/lang/StringBuilder.toString : ()Ljava/lang/String;></span>
<span class="token number">34</span> astore_1
<span class="token number">35</span> <span class="token keyword">return</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>我们创建了 6 个对象</p>
<ul>
<li>对象1：<code v-pre>new StringBuilder()</code>  （ 0 new #2 <code v-pre>&lt;java/lang/StringBuilder&gt;</code>）</li>
<li>对象2：<code v-pre>new String(&quot;a&quot;)</code>  （7 new #4 <code v-pre>&lt;java/lang/String&gt;</code>）</li>
<li>对象3：常量池中的 “a”  （11 ldc #5 <code v-pre>&lt;a&gt;</code>）</li>
<li>对象4：<code v-pre>new String(&quot;b&quot;)</code>  （19 new #4 <code v-pre>&lt;java/lang/String&gt;</code>）</li>
<li>对象5：常量池中的 “b”  （23 ldc #8 <code v-pre>&lt;b&gt;</code>）</li>
<li>对象6：toString 中会创建一个 <code v-pre>new String(&quot;ab&quot;)</code> （31 invokevirtual #9 <code v-pre>&lt;java/lang/StringBuilder.toString : ()Ljava/lang/String;&gt;</code>）
<ul>
<li>toString( )的调用，在字符串常量池中，没有生成&quot;ab&quot;</li>
</ul>
</li>
</ul>
<p>StringBuilder中toString( )源码</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>我们转换成字节码来查看</p>
<figure><img src="@source/Java/jvm/part1/images/798a9f236ca88d01b7c7f408ac09dc20.png" alt="Untitled" tabindex="0" loading="lazy"><figcaption>Untitled</figcaption></figure>
<p>可以看到toString( )里面只是new了一个String对象，并没有存放到字符串常量池中</p>
<h2 id="intern的使用-jdk6-vs-jdk7-8" tabindex="-1"><a class="header-anchor" href="#intern的使用-jdk6-vs-jdk7-8" aria-hidden="true">#</a> intern的使用：JDK6 vs JDK7/8</h2>
<p>注意观看注释：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">StringIntern</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        ...
        s3<span class="token punctuation">.</span><span class="token function">intern</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// 在字符串常量池中生成"11"。</span>
        <span class="token comment">// 如何理解：jdk6:在常量池中真正创建了一个新的对象"11",也就有新的地址。</span>
        <span class="token comment">//         jdk7:此时常量池中并没有真正创建"11",而是创建一个指向堆空间中new String("11")的地址</span>
...
<span class="token class-name">String</span> s4 <span class="token operator">=</span> <span class="token string">"11"</span><span class="token punctuation">;</span>的<span class="token string">"11"</span>的地址
<span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span>s3 <span class="token operator">==</span> s4<span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// jdk6：false  jdk7/8：true</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这段代码中在jdk6的时候intern会在堆中创建一个字符串对象，而s4使用的是常量池的对象，所以两者对象不同；而JDK7的时候，因为s3已经在堆里创建了一个11的对象了，所以intern--字符串常量池就可以引用这个对象，此时在再创建s4的时候是从字符串常量池中取出的，所以两者相等。</p>
<blockquote>
<p>JDK6</p>
</blockquote>
<figure><img src="@source/Java/jvm/part1/images/4bff89dae448aa94592f71326bc4f6a0.png" alt="Untitled" tabindex="0" loading="lazy"><figcaption>Untitled</figcaption></figure>
<blockquote>
<p>JDK7</p>
</blockquote>
<figure><img src="@source/Java/jvm/part1/images/efe92bdce0b79d6013df82f7d278c275.png" alt="Untitled" tabindex="0" loading="lazy"><figcaption>Untitled</figcaption></figure>
<blockquote>
<p>拓展</p>
</blockquote>
<p>调换了上一份代码的两个位置后结果发生了变化</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">StringIntern1</span> <span class="token punctuation">{</span>

    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token comment">//StringIntern.java中练习的拓展：</span>
...
<ul>
<li>JDK1.6中，将这个字符串对象尝试放入字符串常量池中。
<ul>
<li>如果字符串常量池中有，则并不会放入。返回已有的字符串常量池中的对象的地址</li>
<li>如果没有，会把<u>此对象复制一份</u>，放入字符串常量池，并返回字符串常量池中的对象地址</li>
</ul>
</li>
<li>JDK1.7起，将这个字符串对象尝试放入字符串常量池中。
<ul>
<li>如果字符串常量池中有，则并不会放入。返回已有的字符串常量池中的对象的地址</li>
<li>如果没有，则会把<u>对象的引用地址复制一份</u>，放入字符串常量池，并返回字符串常量池中的引用地址</li>
</ul>
</li>
</ul>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">StringExer1</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        ...
        <span class="token class-name">String</span> s2 <span class="token operator">=</span> s<span class="token punctuation">.</span><span class="token function">intern</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span><span class="token comment">//jdk6中：在字符串常量池中创建一个字符串"ab",并把字符串常量池中的"ab"地址返回给s2</span>
                               <span class="token comment">//jdk8中：字符串常量池中没有创建字符串"ab",而是创建一个引用，指向new String("ab")，将此引用返回给s2</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="@source/Java/jvm/part1/images/b23c34ed87aaf2be2eae5b24de0052dd.png" alt="Untitled" tabindex="0" loading="lazy"><figcaption>Untitled</figcaption></figure>
<figure><img src="@source/Java/jvm/part1/images/e610a302fb23ebff2d5069c3ed85473a.png" alt="Untitled" tabindex="0" loading="lazy"><figcaption>Untitled</figcaption></figure>
<blockquote>
<p>练习2</p>
</blockquote>
<p>总结： String s1 = new String(&quot;a&quot;) + new String(&quot;b&quot;); 类似这样的代码是不会在字符串常量池中生成的</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">StringExer2</span> <span class="token punctuation">{</span>

    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
<span class="token comment">//        String s1 = new String("ab"); // 执行完以后，会在字符串常量池中生成“ab”</span>
        <span class="token class-name">String</span> s1 <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">String</span><span class="token punctuation">(</span><span class="token string">"a"</span><span class="token punctuation">)</span> <span class="token operator">+</span> <span class="token keyword">new</span> <span class="token class-name">String</span><span class="token punctuation">(</span><span class="token string">"b"</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// 执行完以后，不会在字符串常量池中生成“ab”</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="@source/Java/jvm/part1/images/9bfac92557e1e3023d28ef255b941c0f.png" alt="Untitled" tabindex="0" loading="lazy"><figcaption>Untitled</figcaption></figure>
<h2 id="intern的效率测试-空间角度" tabindex="-1"><a class="header-anchor" href="#intern的效率测试-空间角度" aria-hidden="true">#</a> intern的效率测试：空间角度</h2>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
...
<span class="token comment">//            arr[i] = new String(String.valueOf(data[i % data.length])).intern();</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>不使用intern：<span class="token number">4385</span>ms
使用intern：<span class="token number">901</span>ms
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>不使用intern的情况下，产生了1千多万个String的实例对象</p>
<figure><img src="@source/Java/jvm/part1/images/image-20220304150012452.png" alt="image-20220304150012452" tabindex="0" loading="lazy"><figcaption>image-20220304150012452</figcaption></figure>
<p>使用intern的情况下，只产生了2百多万个String的实例对象</p>
<figure><img src="@source/Java/jvm/part1/images/image-20220304145945546.png" alt="image-20220304145945546" tabindex="0" loading="lazy"><figcaption>image-20220304145945546</figcaption></figure>
<blockquote>
<p>结论</p>
</blockquote>
<ul>
...
<h1 id="stringtable垃圾回收" tabindex="-1"><a class="header-anchor" href="#stringtable垃圾回收" aria-hidden="true">#</a> StringTable垃圾回收</h1>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
 * String的垃圾回收:
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当循环次数为00时，没有发生GC</p>
<figure><img src="@source/Java/jvm/part1/images/image-20220304150840853.png" alt="image-20220304150840853" tabindex="0" loading="lazy"><figcaption>image-20220304150840853</figcaption></figure>
<p>当循环次数达到，发生了GC</p>
<figure><img src="@source/Java/jvm/part1/images/image-20220304150724397.png" alt="image-20220304150724397" tabindex="0" loading="lazy"><figcaption>image-20220304150724397</figcaption></figure>
<figure><img src="@source/Java/jvm/part1/images/image-20220304150806071.png" alt="image-20220304150806071" tabindex="0" loading="lazy"><figcaption>image-20220304150806071</figcaption></figure>
<h1 id="g1中的string去重操作" tabindex="-1"><a class="header-anchor" href="#g1中的string去重操作" aria-hidden="true">#</a> G1中的String去重操作</h1>
<p>官网地址：<a href="http://openjdk.java.net/jeps/192" target="_blank" rel="noopener noreferrer">JEP 192: String Deduplication in G1 (java.net)<ExternalLinkIcon/></a></p>
<blockquote>
<p>Motivation</p>
<p>Many large-scale Java applications are currently bottlenecked on  memory. Measurements have shown that roughly 25% of the Java heap live  data set in these types of applications is consumed by <code v-pre>String</code> objects. Further, roughly half of those <code v-pre>String</code> objects are duplicates, where duplicates means <code v-pre>string1.equals(string2)</code> is true. Having duplicate <code v-pre>String</code> objects on the heap is, essentially, just a waste of memory. This project will implement automatic and continuous <code v-pre>String</code> deduplication in the G1 garbage collector to avoid wasting memory and reduce the memory footprint.</p>
</blockquote>
<blockquote>
<p>目前，许多大规模的Java应用程序在内存上遇到了瓶颈。测量表明，在这些类型的应用程序中，大约25%的Java堆实时数据集被<code v-pre>String'对象所消耗。此外，这些 &quot;String &quot;对象中大约有一半是重复的，其中重复意味着 &quot;string1.equals(string2) &quot;是真的。在堆上有重复的</code>String’对象，从本质上讲，只是一种内存的浪费。这个项目将在G1垃圾收集器中实现自动和持续的`String’重复数据删除，以避免浪费内存，减少内存占用。</p>
</blockquote>
<blockquote>
...
<blockquote>
<p>许多大规模的Java应用的瓶颈在于内存，测试表明，在这些类型的应用里面，Java堆中存活的数据集合差不多25%是String对象。更进一步，这里面差不多一半string对象是重复的，重复的意思是说： <code v-pre>string1.equals(string2) == true</code>。堆上存在重复的String对象必然是一种内存的浪费。这个项目将在G1垃圾收集器中实现自动持续对重复的string对象进行去重，这样就能避免浪费内存。</p>
</blockquote>
<blockquote>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code># 开启<span class="token class-name">String</span>去重，默认是不开启的，需要手动开启。 
<span class="token class-name">UseStringDeduplication</span><span class="token punctuation">(</span>bool<span class="token punctuation">)</span>  
# 打印详细的去重统计信息 
<span class="token class-name">PrintStringDeduplicationStatistics</span><span class="token punctuation">(</span>bool<span class="token punctuation">)</span>  
# 达到这个年龄的<span class="token class-name">String</span>对象被认为是去重的候选对象
<span class="token class-name">StringpeDuplicationAgeThreshold</span><span class="token punctuation">(</span>uintx<span class="token punctuation">)</span>

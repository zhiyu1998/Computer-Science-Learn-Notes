<template><div><h2 id="剑指-offer-22-链表中倒数第k个节点" tabindex="-1"><a class="header-anchor" href="#剑指-offer-22-链表中倒数第k个节点" aria-hidden="true">#</a> 剑指 Offer 22. 链表中倒数第k个节点</h2>
<p><a href="https://leetcode.cn/problems/lian-biao-zhong-dao-shu-di-kge-jie-dian-lcof/" target="_blank" rel="noopener noreferrer">剑指 Offer 22. 链表中倒数第k个节点<ExternalLinkIcon/></a></p>
<h3 id="两次翻转" tabindex="-1"><a class="header-anchor" href="#两次翻转" aria-hidden="true">#</a> 两次翻转</h3>

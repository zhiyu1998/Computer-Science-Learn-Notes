<template><div><h1 id="剑指-offer-12-矩阵中的路径" tabindex="-1"><a class="header-anchor" href="#剑指-offer-12-矩阵中的路径" aria-hidden="true">#</a> 剑指 Offer 12. 矩阵中的路径</h1>
<p><a href="https://leetcode.cn/problems/ju-zhen-zhong-de-lu-jing-lcof/" target="_blank" rel="noopener noreferrer">https://leetcode.cn/problems/ju-zhen-zhong-de-lu-jing-lcof/<ExternalLinkIcon/></a></p>
...
<h2 id="想法-回溯" tabindex="-1"><a class="header-anchor" href="#想法-回溯" aria-hidden="true">#</a> 想法：回溯</h2>
<p>建议读者读到这题可以亲自试试这题，这道题核心思想就是回溯，是我第二次遇到回溯的问题了，很不熟练，而且这道题评论区说可以升级为困难题，我也是写了一下午，非常浪费时间。如果要看懂是没辙，只能亲自写试试。因为要考虑的问题有点多。</p>
<p>我的思路是这样：</p>
<ul>
<li>先写最后的递归判断<code v-pre>at == word.length()</code></li>
<li><em>边缘检测</em></li>
<li><em>四周检测</em></li>
<li>此时递归部分写的差不多了，这时是可以运行的，但是会遇到一个问题
<ul>
<li>[[&quot;a&quot;,&quot;a&quot;]]  &quot;aaa&quot;这个问题是解决不了的，核心问题就是访问了以前访问过的元素</li>
<li>解决：引出<code v-pre>visited</code>进行标记</li>
</ul>
</li>
<li>标记以后，也可以运行，但是会出现另外一个问题
<ul>
<li>[[&quot;a&quot;,&quot;b&quot;]] &quot;ba&quot; 这个问题是解决不了，核心问题就在于只进行了一次回溯</li>
<li>解决：那么就加入<code v-pre>for循环</code></li>
</ul>
</li>
<li>至此所有问题考虑到位，可以完成此问题</li>
</ul>
...
<p>执行结果：通过</p>
<p>执行用时：5 ms, 在所有 Java 提交中击败了57.98% 的用户</p>
<p>内存消耗：43.2 MB, 在所有 Java 提交中击败了60.52% 的用户</p>
<p>通过测试用例：87 / 87</p>
</blockquote>
</div></template>

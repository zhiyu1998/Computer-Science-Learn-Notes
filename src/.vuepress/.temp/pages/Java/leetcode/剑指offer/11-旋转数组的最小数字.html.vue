<template><div><h1 id="剑指-offer-11-旋转数组的最小数字" tabindex="-1"><a class="header-anchor" href="#剑指-offer-11-旋转数组的最小数字" aria-hidden="true">#</a> 剑指 Offer 11. 旋转数组的最小数字</h1>
<p><a href="https://leetcode.cn/problems/xuan-zhuan-shu-zu-de-zui-xiao-shu-zi-lcof/" target="_blank" rel="noopener noreferrer">https://leetcode.cn/problems/xuan-zhuan-shu-zu-de-zui-xiao-shu-zi-lcof/<ExternalLinkIcon/></a></p>
...
<h2 id="想法一-api" tabindex="-1"><a class="header-anchor" href="#想法一-api" aria-hidden="true">#</a> 想法一：API</h2>
...
<h2 id="想法二-迭代寻求最小值" tabindex="-1"><a class="header-anchor" href="#想法二-迭代寻求最小值" aria-hidden="true">#</a> 想法二：迭代寻求最小值</h2>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">Solution</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">int</span> <span class="token function">minArray</span><span class="token punctuation">(</span><span class="token keyword">int</span><span class="token punctuation">[</span><span class="token punctuation">]</span> numbers<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<p>内存消耗：41.1 MB, 在所有 Java 提交中击败了59.20% 的用户</p>
<p>通过测试用例：192 / 192</p>
</blockquote>
<h2 id="二分查找" tabindex="-1"><a class="header-anchor" href="#二分查找" aria-hidden="true">#</a> 二分查找</h2>
<p>核心思想就是二分法，简单的例子是找数字。</p>
<ol>
<li>找到两个数字之间的数字，进行比较
<ol>
<li>如果中间的数字大于右边的数字，那么左边数字等于中间数字+1</li>
<li>...</li>
</ol>
</li>
</ol>
<p>这里如何理解？以7011111234为例，中间数字为1，左边为7，右边为4。</p>
<p>第一眼可以看到7和0就是要旋的位置，那么知道了答案就可以进行思路整理，通过二分法：</p>
<ol>
<li>第一次j移动到了中间1的位置，j--到了第四个位置</li>
<li>第二次mid为0，小于j，所以移动了0的位置，j--移动到了7的位置，i一直没有变</li>
<li>最后一次比较mid是7，j的位置是0，i = 0，此时 i == j所以没有下一次，直接返回numbers[1] == 0</li>
</ol>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">Solution</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">int</span> <span class="token function">minArray</span><span class="token punctuation">(</span><span class="token keyword">int</span><span class="token punctuation">[</span><span class="token punctuation">]</span> numbers<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<h3 id="二分查找升级-线性查找" tabindex="-1"><a class="header-anchor" href="#二分查找升级-线性查找" aria-hidden="true">#</a> 二分查找升级--线性查找</h3>
<p>这种情况主要是在二分查找的基础上判断，如果i和j出现了相等的情况，那么中间的数值都是相等的，那么可以直接将j--替换成线性查找</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">Solution</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">int</span> <span class="token function">minArray</span><span class="token punctuation">(</span><span class="token keyword">int</span><span class="token punctuation">[</span><span class="token punctuation">]</span> numbers<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token keyword">int</span> i <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">,</span> j <span class="token operator">=</span> numbers<span class="token punctuation">.</span>length <span class="token operator">-</span> <span class="token number">1</span><span class="token punctuation">;</span>
        <span class="token keyword">while</span> <span class="token punctuation">(</span> i <span class="token operator">&lt;</span> j <span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<h2 id="分而治之-快排" tabindex="-1"><a class="header-anchor" href="#分而治之-快排" aria-hidden="true">#</a> 分而治之（快排）</h2>
</div></template>

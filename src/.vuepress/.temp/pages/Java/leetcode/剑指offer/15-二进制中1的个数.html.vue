<template><div><h1 id="剑指-offer-15-二进制中1的个数" tabindex="-1"><a class="header-anchor" href="#剑指-offer-15-二进制中1的个数" aria-hidden="true">#</a> 剑指 Offer 15. 二进制中1的个数</h1>
<p><a href="https://leetcode.cn/problems/er-jin-zhi-zhong-1de-ge-shu-lcof/" target="_blank" rel="noopener noreferrer">https://leetcode.cn/problems/er-jin-zhi-zhong-1de-ge-shu-lcof/<ExternalLinkIcon/></a></p>
...
<p>示例 1：</p>
<p>输入：n = 11 (控制台输入 00000000000000000000000000001011)
输出：3
解释：输入的二进制串 00000000000000000000000000001011 中，共有三位为 '1'。</p>
<p>示例 2：</p>
<p>输入：n = 128 (控制台输入 00000000000000000000000010000000)
输出：1
解释：输入的二进制串 00000000000000000000000010000000 中，共有一位为 '1'。</p>
<p>示例 3：</p>
<p>输入：n = 4294967293 (控制台输入 11111111111111111111111111111101，部分语言中 n = -3）
输出：31
解释：输入的二进制串 11111111111111111111111111111101 中，共有 31 位为 '1'。</p>
<h2 id="想法" tabindex="-1"><a class="header-anchor" href="#想法" aria-hidden="true">#</a> 想法</h2>
...
<p><strong>601 / 601</strong> 个通过测试用例</p>
<p>状态：<em>通过</em></p>
<p>执行用时: <strong>0 ms</strong></p>
<p>内存消耗: <strong>39 MB</strong></p>
</blockquote>
<p>简化后：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Solution</span> <span class="token punctuation">{</span>
    <span class="token comment">// you need to treat n as an unsigned value</span>
...
<p>内存消耗：39 MB, 在所有 Java 提交中击败了5.02% 的用户</p>
<p>通过测试用例：601 / 601</p>
</blockquote>
<ul>
<li>(n−1) 解析： 二进制数字 nnn 最右边的 111 变成 000 ，此 111 右边的 000 都变成 111 。</li>
<li>n&amp;(n−1)n &amp; (n - 1)n&amp;(n−1) 解析： 二进制数字 nnn 最右边的 111 变成 000 ，其余不变。</li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Solution</span> <span class="token punctuation">{</span>
    <span class="token comment">// you need to treat n as an unsigned value</span>
    <span class="token keyword">public</span> <span class="token keyword">int</span> <span class="token function">hammingWeight</span><span class="token punctuation">(</span><span class="token keyword">int</span> n<span class="token punctuation">)</span> <span class="token punctuation">{</span>

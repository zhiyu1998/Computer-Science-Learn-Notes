<template><div><h2 id="🔗-分布式" tabindex="-1"><a class="header-anchor" href="#🔗-分布式" aria-hidden="true">#</a> 🔗 分布式</h2>
<h3 id="理论基础" tabindex="-1"><a class="header-anchor" href="#理论基础" aria-hidden="true">#</a> 理论基础</h3>
<h4 id="cap理论" tabindex="-1"><a class="header-anchor" href="#cap理论" aria-hidden="true">#</a> CAP理论</h4>
<p>CAP 理论/定理起源于 2000年，由加州大学伯克利分校的Eric Brewer教授在分布式计算原理研讨会（PODC）上提出，因此 CAP定理又被称作 <strong>布鲁尔定理（Brewer’s theorem）</strong></p>
<p>2年后，麻省理工学院的Seth Gilbert和Nancy Lynch 发表了布鲁尔猜想的证明，CAP理论正式成为分布式领域的定理。</p>
<h5 id="简介" tabindex="-1"><a class="header-anchor" href="#简介" aria-hidden="true">#</a> 简介</h5>
...
<figure><img src="@source/Java/eightpart/personal_images/image-20220726125103940.png" alt="image-20220726125103940" tabindex="0" loading="lazy"><figcaption>image-20220726125103940</figcaption></figure>
...
<h5 id="网络分区" tabindex="-1"><a class="header-anchor" href="#网络分区" aria-hidden="true">#</a> 网络分区</h5>
<blockquote>
<p>分布式系统中，多个节点之前的网络本来是连通的，但是因为某些故障（比如部分节点网络出了问题）某些节点之间不连通了，整个网络就分成了几块区域，这就叫网络分区。</p>
</blockquote>
<figure><img src="@source/Java/eightpart/personal_images/image-20220726132654526.png" alt="image-20220726132654526" tabindex="0" loading="lazy"><figcaption>image-20220726132654526</figcaption></figure>
<h5 id="不是所谓的-3-选-2" tabindex="-1"><a class="header-anchor" href="#不是所谓的-3-选-2" aria-hidden="true">#</a> 不是所谓的“3 选 2”</h5>
...
<h5 id="cap-实际应用案例" tabindex="-1"><a class="header-anchor" href="#cap-实际应用案例" aria-hidden="true">#</a> CAP 实际应用案例</h5>
...
<figure><img src="@source/Java/eightpart/personal_images/image-20220726132721865.png" alt="image-20220726132721865" tabindex="0" loading="lazy"><figcaption>image-20220726132721865</figcaption></figure>
...
<h4 id="base理论" tabindex="-1"><a class="header-anchor" href="#base理论" aria-hidden="true">#</a> Base理论</h4>
...
<h5 id="简介-1" tabindex="-1"><a class="header-anchor" href="#简介-1" aria-hidden="true">#</a> 简介</h5>
...
<h5 id="base-理论的核心思想" tabindex="-1"><a class="header-anchor" href="#base-理论的核心思想" aria-hidden="true">#</a> BASE 理论的核心思想</h5>
...
<h5 id="base-理论三要素" tabindex="-1"><a class="header-anchor" href="#base-理论三要素" aria-hidden="true">#</a> BASE 理论三要素</h5>
<figure><img src="@source/Java/eightpart/personal_images/image-20220726133418075.png" alt="image-20220726133418075" tabindex="0" loading="lazy"><figcaption>image-20220726133418075</figcaption></figure>
<h5 id="基本可用" tabindex="-1"><a class="header-anchor" href="#基本可用" aria-hidden="true">#</a> 基本可用</h5>
...
<h5 id="软状态" tabindex="-1"><a class="header-anchor" href="#软状态" aria-hidden="true">#</a> 软状态</h5>
...
<h4 id="paxos-算法" tabindex="-1"><a class="header-anchor" href="#paxos-算法" aria-hidden="true">#</a> Paxos 算法</h4>
<p>Paxos 算法是 Leslie Lamport（<a href="https://zh.wikipedia.org/wiki/%E8%8E%B1%E6%96%AF%E5%88%A9%C2%B7%E5%85%B0%E4%BC%AF%E7%89%B9" target="_blank" rel="noopener noreferrer">莱斯利·兰伯特<ExternalLinkIcon/></a>）在 <strong>1990</strong> 年提出了一种分布式系统 <strong>共识</strong> 算法。这也是第一个被证明完备的共识算法（前提是不存在拜占庭将军问题，也就是没有恶意节点）。</p>
...
<p>直到 1998 年，系统研究中心 (Systems Research  Center，SRC）的两个技术研究员需要找一些合适的分布式算法来服务他们正在构建的分布式系统，Paxos  算法刚好可以解决他们的部分需求。因此，兰伯特就把论文发给了他们。在看了论文之后，这俩大佬觉得论文还是挺不错的。于是，兰伯特在 <strong>1998</strong> 年重新发表论文 <a href="http://lamport.azurewebsites.net/pubs/lamport-paxos.pdf" target="_blank" rel="noopener noreferrer">《The Part-Time Parliament》<ExternalLinkIcon/></a>。</p>
<p>论文发表之后，各路学者直呼看不懂，言语中还略显调侃之意。这谁忍得了，在 <strong>2001</strong> 年的时候，兰伯特专门又写了一篇 <a href="http://lamport.azurewebsites.net/pubs/paxos-simple.pdf" target="_blank" rel="noopener noreferrer">《Paxos Made Simple》<ExternalLinkIcon/></a>的论文来简化对 Paxos 的介绍，主要讲述两阶段共识协议部分，顺便还不忘嘲讽一下这群学者。</p>
<p>《Paxos Made Simple》这篇论文就 14 页，相比于 《The Part-Time Parliament》的33 页精简了不少。最关键的是这篇论文的摘要就一句话：</p>
<blockquote>
...
<p>由于 Paxos 算法在国际上被公认的非常难以理解和实现，因此不断有人尝试简化这一算法。到了2013 年才诞生了一个比 Paxos 算法更易理解和实现的共识算法—<a href="https://javaguide.cn/distributed-system/theorem&amp;algorithm&amp;protocol/raft-algorithm.html" target="_blank" rel="noopener noreferrer">Raft 算法<ExternalLinkIcon/></a> 。更具体点来说，Raft 是Multi-Paxos的一个变种，其简化了 Multi-Paxos 的思想，变得更容易被理解以及工程实现。</p>
...
<li>兰伯特当时提出的 Paxos 算法主要包含 2 个部分:Basic Paxos 算法和Multi-Paxos 思想。</li>
<li>Raft 算法、ZAB 协议、 Fast Paxos 算法都是基于 Paxos 算法改进而来。</li>
</ul>
<h5 id="一致性-consistency-与共识-consensus" tabindex="-1"><a class="header-anchor" href="#一致性-consistency-与共识-consensus" aria-hidden="true">#</a> 一致性（Consistency）与共识（Consensus）</h5>
<p>很多人会误把 Paxos 看作是一致性算法，这其实是一个非常大的误区。</p>
<p>⚠️注意：<strong>Paxos 不是一致性算法而是共识算法，一致性和共识并不是一个概念。</strong></p>
<h5 id="basic-paxos-算法" tabindex="-1"><a class="header-anchor" href="#basic-paxos-算法" aria-hidden="true">#</a> Basic Paxos 算法</h5>
...
<figure><img src="@source/Java/eightpart/personal_images/image-20220726133642419.png" alt="image-20220726133642419" tabindex="0" loading="lazy"><figcaption>image-20220726133642419</figcaption></figure>
<h5 id="multi-paxos-思想" tabindex="-1"><a class="header-anchor" href="#multi-paxos-思想" aria-hidden="true">#</a> Multi Paxos 思想</h5>
<p>因为兰伯特提到的 Multi-Paxos 思想，缺少代码实现的必要细节(比如怎么选举领导者)，所以在理解上比较难。</p>
<p>⚠️<strong>注意</strong> ： Multi-Paxos 只是一种思想，这种思想的核心就是通过多个 Basic Paxos 实例就一系列值达成共识。</p>
<p>二阶段提交是达成共识常用的方式，Basic Paxos 就是通过二阶段提交的方式来达成共识。Basic Paxos 还支持容错，少于一般的节点出现故障时，集群也能正常工作。</p>
<h4 id="raft-算法" tabindex="-1"><a class="header-anchor" href="#raft-算法" aria-hidden="true">#</a> Raft 算法</h4>
...
<h5 id="拜占庭将军" tabindex="-1"><a class="header-anchor" href="#拜占庭将军" aria-hidden="true">#</a> 拜占庭将军</h5>
...
<h5 id="共识算法" tabindex="-1"><a class="header-anchor" href="#共识算法" aria-hidden="true">#</a> 共识算法</h5>
...
<figure><img src="@source/Java/eightpart/personal_images/image-20220726134912102.png" alt="image-20220726134912102" tabindex="0" loading="lazy"><figcaption>image-20220726134912102</figcaption></figure>
...
<h5 id="节点类型" tabindex="-1"><a class="header-anchor" href="#节点类型" aria-hidden="true">#</a> 节点类型</h5>
...
<figure><img src="@source/Java/eightpart/personal_images/image-20220726134943719.png" alt="image-20220726134943719" tabindex="0" loading="lazy"><figcaption>image-20220726134943719</figcaption></figure>
<h5 id="任期" tabindex="-1"><a class="header-anchor" href="#任期" aria-hidden="true">#</a> 任期</h5>
<figure><img src="@source/Java/eightpart/personal_images/image-20220726134951395.png" alt="image-20220726134951395" tabindex="0" loading="lazy"><figcaption>image-20220726134951395</figcaption></figure>
...
<h5 id="日志" tabindex="-1"><a class="header-anchor" href="#日志" aria-hidden="true">#</a> 日志</h5>
<ul>
...
<h5 id="领导人选举" tabindex="-1"><a class="header-anchor" href="#领导人选举" aria-hidden="true">#</a> 领导人选举</h5>
...
<h5 id="日志复制" tabindex="-1"><a class="header-anchor" href="#日志复制" aria-hidden="true">#</a> 日志复制</h5>
...
<h5 id="选举限制" tabindex="-1"><a class="header-anchor" href="#选举限制" aria-hidden="true">#</a> 选举限制</h5>
...
<h5 id="节点崩溃" tabindex="-1"><a class="header-anchor" href="#节点崩溃" aria-hidden="true">#</a> 节点崩溃</h5>
...
<h5 id="时间与可用性" tabindex="-1"><a class="header-anchor" href="#时间与可用性" aria-hidden="true">#</a> 时间与可用性</h5>
<p>raft 的要求之一就是安全性不依赖于时间：系统不能仅仅因为一些事件发生的比预想的快一些或者慢一些就产生错误。为了保证上述要求，最好能满足以下的时间条件：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>broadcastTime &lt;&lt; electionTimeout &lt;&lt; MTBF
...
<h3 id="了解rpc吗" tabindex="-1"><a class="header-anchor" href="#了解rpc吗" aria-hidden="true">#</a> 了解RPC吗？</h3>
<p>一言蔽之：<strong>RPC （Remote Procedure Call）的出现就是为了让你调用远程方法像调用本地方法一样简单。</strong></p>
...
<figure><img src="@source/Java/eightpart/personal_images/image-20220609151233412.png" alt="image-20220609151233412" tabindex="0" loading="lazy"><figcaption>image-20220609151233412</figcaption></figure>
<ol>
...
<h3 id="有哪些常见的-rpc-框架" tabindex="-1"><a class="header-anchor" href="#有哪些常见的-rpc-框架" aria-hidden="true">#</a> 有哪些常见的 RPC 框架？</h3>
...
<figure><img src="@source/Java/eightpart/personal_images/image-20220723235648648.png" alt="image-20220723235648648" tabindex="0" loading="lazy"><figcaption>image-20220723235648648</figcaption></figure>
...
<figure><img src="@source/Java/eightpart/personal_images/image-20220723235657177.png" alt="image-20220723235657177" tabindex="0" loading="lazy"><figcaption>image-20220723235657177</figcaption></figure>
<p>Dubbo 是由阿里开源，后来加入了 Apache 。正式由于 Dubbo 的出现，才使得越来越多的公司开始使用以及接受分布式架构。</p>
<p>Dubbo 算的是比较优秀的国产开源项目了，它的源码也是非常值得学习和阅读的！</p>
<ul>
<li>Github ：<a href="https://github.com/apache/incubator-dubbo" target="_blank" rel="noopener noreferrer">https://github.com/apache/incubator-dubbo<ExternalLinkIcon/></a></li>
<li>官网：<a href="https://dubbo.apache.org/zh/" target="_blank" rel="noopener noreferrer">https://dubbo.apache.org/zh/<ExternalLinkIcon/></a></li>
</ul>
<h4 id="motan" tabindex="-1"><a class="header-anchor" href="#motan" aria-hidden="true">#</a> Motan</h4>
...
<ul>
<li>从 Motan 看 RPC 框架设计：<a href="http://kriszhang.com/motan-rpc-impl/" target="_blank" rel="noopener noreferrer">http://kriszhang.com/motan-rpc-impl/<ExternalLinkIcon/></a></li>
<li>Motan 中文文档：<a href="https://github.com/weibocom/motan/wiki/zh_overview" target="_blank" rel="noopener noreferrer">https://github.com/weibocom/motan/wiki/zh_overview<ExternalLinkIcon/></a></li>
</ul>
<h4 id="grpc" tabindex="-1"><a class="header-anchor" href="#grpc" aria-hidden="true">#</a> gRPC</h4>
<figure><img src="@source/Java/eightpart/personal_images/image-20220723235737977.png" alt="image-20220723235737977" tabindex="0" loading="lazy"><figcaption>image-20220723235737977</figcaption></figure>
...
<p><strong>何谓 ProtoBuf？</strong> <a href="https://github.com/protocolbuffers/protobuf" target="_blank" rel="noopener noreferrer">ProtoBuf（ Protocol Buffer）<ExternalLinkIcon/></a></p>
<p>是一种更加灵活、高效的数据格式，可用于通讯协议、数据存储等领域，基本支持所有主流编程语言且与平台无关。不过，通过 ProtoBuf 定义接口和数据类型还挺繁琐的，这是一个小问题。</p>
<figure><img src="@source/Java/eightpart/personal_images/image-20220723235747598.png" alt="image-20220723235747598" tabindex="0" loading="lazy"><figcaption>image-20220723235747598</figcaption></figure>
<p>不得不说，gRPC 的通信层的设计还是非常优秀的，<a href="https://dubbogo.github.io/" target="_blank" rel="noopener noreferrer">Dubbo-go 3.0<ExternalLinkIcon/></a></p>
<p>的通信层改进主要借鉴了 gRPC。</p>
<p>不过，gRPC 的设计导致其几乎没有服务治理能力。如果你想要解决这个问题的话，就需要依赖其他组件比如腾讯的 PolarisMesh（北极星）了。</p>
<ul>
<li>Github：<a href="https://github.com/grpc/grpc" target="_blank" rel="noopener noreferrer">https://github.com/grpc/grpc<ExternalLinkIcon/></a></li>
<li>官网：<a href="https://grpc.io/" target="_blank" rel="noopener noreferrer">https://grpc.io/<ExternalLinkIcon/></a></li>
</ul>
...
<p><code v-pre>Thrift</code>支持多种不同的<strong>编程语言</strong>，包括<code v-pre>C++</code>、<code v-pre>Java</code>、<code v-pre>Python</code>、<code v-pre>PHP</code>、<code v-pre>Ruby</code>等（相比于 gRPC 支持的语言更多 ）。</p>
<ul>
<li>官网：<a href="https://thrift.apache.org/" target="_blank" rel="noopener noreferrer">https://thrift.apache.org/<ExternalLinkIcon/></a></li>
<li>Thrift 简单介绍：<a href="https://www.jianshu.com/p/8f25d057a5a9" target="_blank" rel="noopener noreferrer">https://www.jianshu.com/p/8f25d057a5a9<ExternalLinkIcon/></a></li>
</ul>
...
<figure><img src="@source/Java/eightpart/personal_images/image-20220723235849004.png" alt="image-20220723235849004" tabindex="0" loading="lazy"><figcaption>image-20220723235849004</figcaption></figure>
<p>Dubbo 也是 Spring Cloud Alibaba 里面的一个组件。</p>
<figure><img src="@source/Java/eightpart/personal_images/image-20220723235856647.png" alt="image-20220723235856647" tabindex="0" loading="lazy"><figcaption>image-20220723235856647</figcaption></figure>
...
<h3 id="了解分布式事务吗" tabindex="-1"><a class="header-anchor" href="#了解分布式事务吗" aria-hidden="true">#</a> 了解分布式事务吗？</h3>
...
<h4 id="✔️2pc-两段式提交" tabindex="-1"><a class="header-anchor" href="#✔️2pc-两段式提交" aria-hidden="true">#</a> ✔️2pc（两段式提交）</h4>
<figure><img src="@source/Java/eightpart/personal_images/image-20220617144013552.png" alt="image-20220617144013552" tabindex="0" loading="lazy"><figcaption>image-20220617144013552</figcaption></figure>
...
<h4 id="✔️3pc" tabindex="-1"><a class="header-anchor" href="#✔️3pc" aria-hidden="true">#</a> ✔️3PC</h4>
<p>3PC 的出现是为了解决 2PC 的一些问题，相比于 2PC 它在<strong>参与者中也引入了超时机制</strong>，并且<strong>新增了一个阶段</strong>使得参与者可以利用这一个阶段统一各自的状态。</p>
<p>让我们来详细看一下。</p>
<p>3PC 包含了三个阶段，分别是<strong>准备阶段、预提交阶段和提交阶段</strong>，对应的英文就是：<code v-pre>CanCommit、PreCommit 和 DoCommit</code>。</p>
...
<figure><img src="@source/Java/eightpart/personal_images/image-20220725145659669.png" alt="image-20220725145659669" tabindex="0" loading="lazy"><figcaption>image-20220725145659669</figcaption></figure>
...
<h4 id="✔️tcc柔性补偿" tabindex="-1"><a class="header-anchor" href="#✔️tcc柔性补偿" aria-hidden="true">#</a> ✔️TCC柔性补偿</h4>
<ol>
<li>启动事务（业务系统）</li>
<li>尝试调不同的服务（接口）</li>
<li>事务具体成功了还是失败了会告诉事务协调器</li>
<li>由事务协调器来调用confirm、cancel</li>
</ol>
<p><strong>2PC 和 3PC 都是数据库层面的，而 TCC 是业务层面的分布式事务</strong>，就像我前面说的分布式事务不仅仅包括数据库的操作，还包括发送短信等，这时候 TCC 就派上用场了！</p>
<p>TCC 指的是<code v-pre>Try - Confirm - Cancel</code>。</p>
<ul>
...
<figure><img src="@source/Java/eightpart/personal_images/image-20220913115340867.png" alt="image-20220913115340867" tabindex="0" loading="lazy"><figcaption>image-20220913115340867</figcaption></figure>
<p>可以看到流程还是很简单的，难点在于业务上的定义，对于每一个操作你都需要定义三个动作分别对应<code v-pre>Try - Confirm - Cancel</code>。</p>
...
<h4 id="了解-最大努力通知" tabindex="-1"><a class="header-anchor" href="#了解-最大努力通知" aria-hidden="true">#</a> （了解）最大努力通知</h4>
...
<h4 id="了解-本地消息表" tabindex="-1"><a class="header-anchor" href="#了解-本地消息表" aria-hidden="true">#</a> （了解）本地消息表</h4>
...
<h4 id="消息事务" tabindex="-1"><a class="header-anchor" href="#消息事务" aria-hidden="true">#</a> 消息事务</h4>
...
<figure><img src="@source/Java/eightpart/personal_images/image-20220725145800448.png" alt="image-20220725145800448" tabindex="0" loading="lazy"><figcaption>image-20220725145800448</figcaption></figure>
<p>可以看到消息事务实现的也是最终一致性。</p>
<h4 id="最终一致性-1" tabindex="-1"><a class="header-anchor" href="#最终一致性-1" aria-hidden="true">#</a> 最终一致性</h4>
<figure><img src="@source/Java/eightpart/personal_images/image-20220617144020576.png" alt="image-20220617144020576" tabindex="0" loading="lazy"><figcaption>image-20220617144020576</figcaption></figure>
<p>整个流程中，我们能保证是：</p>
<ul>
...
<h4 id="分布式事务比较" tabindex="-1"><a class="header-anchor" href="#分布式事务比较" aria-hidden="true">#</a> 分布式事务比较</h4>
<ul>
<li>基于消息事务是强一致性事务（会造成等待），会存在资源浪费</li>
<li>TCC事务是柔性事务，在try阶段要对资源做预留</li>
<li>TCC事务在确认或取消阶段释放资源</li>
<li>与基于消息事务相比，TCC的时效性要更好</li>
</ul>
<h4 id="分布式事务注意点" tabindex="-1"><a class="header-anchor" href="#分布式事务注意点" aria-hidden="true">#</a> 分布式事务注意点</h4>
<ul>
<li>不要在分布式事务捕获任何异常</li>
<li>使用TCC-Transaction的时候，confirm和cancel的幂等性需要自己代码支持
<ul>
<li>这就解释了为什么要在confirm和cancel里检查订单状态，而不直接修改为结束状态 ---&gt; 保证幂等性</li>
</ul>
</li>
</ul>
<h4 id="tcc-transaction框架" tabindex="-1"><a class="header-anchor" href="#tcc-transaction框架" aria-hidden="true">#</a> TCC-Transaction框架</h4>
<figure><img src="@source/Java/eightpart/personal_images/image-20220913170527093.png" alt="image-20220913170527093" tabindex="0" loading="lazy"><figcaption>image-20220913170527093</figcaption></figure>
<ol>
<li>什么时候生成的TRANSACTION_CONTEXT隐式参数</li>
<li>如何判断大事务下有哪些小事务</li>
<li>为什么要有@Compensable注解</li>
</ol>
<h3 id="常见保证幂等的方式" tabindex="-1"><a class="header-anchor" href="#常见保证幂等的方式" aria-hidden="true">#</a> 常见保证幂等的方式</h3>
<h4 id="什么是幂等性" tabindex="-1"><a class="header-anchor" href="#什么是幂等性" aria-hidden="true">#</a> 什么是幂等性</h4>
<p>幂等是一个数学与计算机学概念，在数学中某一元运算为幂等时，其作用在任一元素两次后会和其作用一次的结果相同。</p>
<p>在计算机中编程中，一个幂等操作的特点是其任意多次执行所产生的影响均与一次执行的影响相同。幂等函数或幂等方法是指可以使用相同参数重复执行，并能获得相同结果的函数。这些函数不会影响系统状态，也不用担心重复执行会对系统造成改变。</p>
<h4 id="什么是接口幂等性" tabindex="-1"><a class="header-anchor" href="#什么是接口幂等性" aria-hidden="true">#</a> 什么是接口幂等性</h4>
...
<h4 id="为什么需要实现幂等性" tabindex="-1"><a class="header-anchor" href="#为什么需要实现幂等性" aria-hidden="true">#</a> 为什么需要实现幂等性</h4>
...
<h4 id="引入幂等性后对系统的影响" tabindex="-1"><a class="header-anchor" href="#引入幂等性后对系统的影响" aria-hidden="true">#</a> 引入幂等性后对系统的影响</h4>
...
<h4 id="restful-api-接口的幂等性" tabindex="-1"><a class="header-anchor" href="#restful-api-接口的幂等性" aria-hidden="true">#</a> Restful API 接口的幂等性</h4>
<p>现在流行的 Restful 推荐的几种 HTTP 接口方法中，分别存在幂等行与不能保证幂等的方法，如下：</p>
<ul>
<li>
<p>√ 满足幂等</p>
</li>
...
<td style="text-align:center">Get 方法用于获取资源。其一般不会也不应当对系统资源进行改变，所以是幂等的。</td>
</tr>
<tr>
<td style="text-align:center">Post</td>
<td style="text-align:center">×</td>
<td style="text-align:center">Post 方法一般用于创建新的资源。其每次执行都会新增数据，所以不是幂等的。</td>
</tr>
<tr>
<td style="text-align:center">Put</td>
<td style="text-align:center">-</td>
<td style="text-align:center">Put 方法一般用于修改资源。该操作则分情况来判断是不是满足幂等，更新操作中直接根据某个值进行更新，也能保持幂等。不过执行累加操作的更新是非幂等。</td>
</tr>
<tr>
<td style="text-align:center">Delete</td>
<td style="text-align:center">-</td>
<td style="text-align:center">Delete  方法一般用于删除资源。该操作则分情况来判断是不是满足幂等，当根据唯一值进行删除时，删除同一个数据多次执行效果一样。不过需要注意，带查询条件的删除则就不一定满足幂等了。例如在根据条件删除一批数据后，这时候新增加了一条数据也满足条件，然后又执行了一次删除，那么将会导致新增加的这条满足条件数据也被删除。</td>
</tr>
</tbody>
</table>
<h4 id="如何实现幂等性" tabindex="-1"><a class="header-anchor" href="#如何实现幂等性" aria-hidden="true">#</a> 如何实现幂等性</h4>
<h5 id="方案一-数据库唯一主键" tabindex="-1"><a class="header-anchor" href="#方案一-数据库唯一主键" aria-hidden="true">#</a> 方案一：数据库唯一主键</h5>
...
<figure><img src="@source/Java/eightpart/personal_images/image-20220725150136872.png" alt="image-20220725150136872" tabindex="0" loading="lazy"><figcaption>image-20220725150136872</figcaption></figure>
<p>主要流程：</p>
<ul>
...
<h5 id="方案二-数据库乐观锁" tabindex="-1"><a class="header-anchor" href="#方案二-数据库乐观锁" aria-hidden="true">#</a> 方案二：数据库乐观锁</h5>
<p><strong>方案描述：</strong></p>
...
<p><strong>描述示例：</strong></p>
<figure><img src="@source/Java/eightpart/personal_images/image-20220725150153331.png" alt="image-20220725150153331" tabindex="0" loading="lazy"><figcaption>image-20220725150153331</figcaption></figure>
<p>例如，存在如下的数据表中：</p>
<table>
<thead>
<tr>
...
<td style="text-align:left">小米手机</td>
...
<td style="text-align:left">华为手机</td>
<td style="text-align:left">1600</td>
</tr>
</tbody>
</table>
<p>为了每次执行更新时防止重复更新，确定更新的一定是要更新的内容，我们通常都会添加一个 version 字段记录当前的记录版本，这样在更新时候将该值带上，那么只要执行更新操作就能确定一定更新的是某个对应版本下的信息。</p>
<table>
<thead>
<tr>
<th style="text-align:left">id</th>
...
<p>这样每次执行更新时候，都要指定要更新的版本号，如下操作就能准确更新 version=5 的信息：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>UPDATE my_table SET price=price+50,version=version+1 WHERE id=1 AND version=5
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>上面 WHERE 后面跟着条件 id=1 AND version=5 被执行后，id=1 的 version 被更新为 6，所以如果重复执行该条  SQL 语句将不生效，因为 id=1 AND version=5 的数据已经不存在，这样就能保住更新的幂等，多次更新对结果不会产生影响。</p>
<h5 id="方案三-防重-token-令牌" tabindex="-1"><a class="header-anchor" href="#方案三-防重-token-令牌" aria-hidden="true">#</a> 方案三：防重 Token 令牌</h5>
<p><strong>方案描述：</strong></p>
...
<p><strong>主要流程：</strong></p>
<figure><img src="@source/Java/eightpart/personal_images/image-20220725150246041.png" alt="image-20220725150246041" tabindex="0" loading="lazy"><figcaption>image-20220725150246041</figcaption></figure>
<ul>
...
<h5 id="方案四-下游传递唯一序列号" tabindex="-1"><a class="header-anchor" href="#方案四-下游传递唯一序列号" aria-hidden="true">#</a> 方案四:下游传递唯一序列号</h5>
<p><strong>方案描述：</strong></p>
...
<p><strong>主要流程：</strong></p>
<figure><img src="@source/Java/eightpart/personal_images/image-20220725150306807.png" alt="image-20220725150306807" tabindex="0" loading="lazy"><figcaption>image-20220725150306807</figcaption></figure>
<p>主要步骤：</p>
<ul>
...
<h3 id="分布式系统接口-如何避免表单的重复提交" tabindex="-1"><a class="header-anchor" href="#分布式系统接口-如何避免表单的重复提交" aria-hidden="true">#</a> 分布式系统接口，如何避免表单的重复提交？</h3>
<h4 id="幂等性" tabindex="-1"><a class="header-anchor" href="#幂等性" aria-hidden="true">#</a> 幂等性</h4>
<p>**效果：**系统对某接口的多次请求，都应该返回同样的结果！（网络访问失败的场景除外）</p>
<p>**目的：**避免因为各种原因，重复请求导致的业务重复处理</p>
<h4 id="重复请求场景案例" tabindex="-1"><a class="header-anchor" href="#重复请求场景案例" aria-hidden="true">#</a> 重复请求场景案例</h4>
<p>1，客户端第一次请求后，网络异常导致收到请求执行逻辑但是没有返回给客户端，客户端的重新发起请求</p>
<p>2，客户端迅速点击按钮提交，导致同一逻辑被多次发送到服务器</p>
<p><em>简单来划分，业务逻辑无非都可以归纳为增删改查！</em></p>
<p><strong>对于查询</strong>，内部不包含其他操作，属于只读性质的那种业务必然符合幂等性要求的。</p>
<p><strong>对于删除</strong>，重复做删除请求至少不会造成数据杂乱，不过也有些场景更希望重复点击提示的是删除成功，而不是目标不存在的提示。</p>
<p><strong>对于新增和修改</strong>，这里是今天要重点关注的部分：新增，需要避免重复插入；修改，避免进行无效的重复修改；</p>
<h4 id="幂等性的实现方式" tabindex="-1"><a class="header-anchor" href="#幂等性的实现方式" aria-hidden="true">#</a> 幂等性的实现方式</h4>
<p>**实现方法：**客户端做某一请求的时候带上识别参数标识，服务端对此标识进行识别，重复请求则重复返回第一次的结果即可。</p>
<p>**举个栗子：**比如添加请求的表单里，在打开添加表单页面的时候，就生成一个AddId标识，这个AddId跟着表单一起提交到后台接口。</p>
<p>后台接口根据这个AddId，服务端就可以进行缓存标记并进行过滤，缓存值可以是AddId作为缓存key，返回内容作为缓存Value，这样即使添加按钮被多次点下也可以识别出来。</p>
<p>这个AddId什么时候更新呢？只有在保存成功并且清空表单之后，才变更这个AddId标识，从而实现新数据的表单提交</p>
<h3 id="有几种生成唯一id的方式" tabindex="-1"><a class="header-anchor" href="#有几种生成唯一id的方式" aria-hidden="true">#</a> 有几种生成唯一ID的方式？</h3>
<p>在复杂分布式系统和庞大数据量的场景下，一般需要对大量数据进行唯一标识。</p>
<p>比如：</p>
<ul>
<li>数据库分库分表后需要用一个唯一ID来标识一条数据。</li>
<li>nosql中的数据，需要一个唯一ID与其他数据源的数据进行关联</li>
</ul>
<p>本文对比和总结了常见的几种方式，在座同学可以进行参考。</p>
<p>我在实际项目中经常使用ksuid算法。它简单可靠，还可按时间排序</p>
<h4 id="uuid" tabindex="-1"><a class="header-anchor" href="#uuid" aria-hidden="true">#</a> UUID</h4>
<p><code v-pre>UUID （Universally Unique Identifier）</code>，通用唯一识别码的缩写。UUID是由一组32位数的16进制数字所构成，所以UUID理论上的总数为 <code v-pre>16^32=2^128</code>，约等于 <code v-pre>3.4 x 10^38</code>。也就是说若每纳秒产生1兆个UUID，要花100亿年才会将所有UUID用完。</p>
<p>生成的UUID是由 8-4-4-4-12格式的数据组成，其中32个字符和4个连字符' - '，一般我们使用的时候会将连字符删除 uuid.<code v-pre>toString().replaceAll(&quot;-&quot;,&quot;&quot;)</code>。</p>
<p>目前UUID的产生方式有5种版本，每个版本的算法不同，应用范围也不同。</p>
<ul>
<li><code v-pre>基于时间的UUID</code> - 版本1： 这个一般是通过当前时间，随机数，和本地Mac地址来计算出来，可以通过 org.apache.logging.log4j.core.util包中的 UuidUtil.getTimeBasedUuid()来使用或者其他包中工具。由于使用了MAC地址，因此能够确保唯一性，但是同时也暴露了MAC地址，私密性不够好。</li>
<li><code v-pre>DCE安全的UUID</code> - 版本2 DCE（Distributed Computing Environment）安全的UUID和基于时间的UUID算法相同，但会把时间戳的前4位置换为POSIX的UID或GID。这个版本的UUID在实际中较少用到。</li>
<li><code v-pre>基于名字的UUID（MD5）</code>- 版本3 基于名字的UUID通过计算名字和名字空间的MD5散列值得到。这个版本的UUID保证了：相同名字空间中不同名字生成的UUID的唯一性；不同名字空间中的UUID的唯一性；相同名字空间中相同名字的UUID重复生成是相同的。</li>
<li><code v-pre>随机UUID</code> - 版本4 根据随机数，或者伪随机数生成UUID。这种UUID产生重复的概率是可以计算出来的，但是重复的可能性可以忽略不计，因此该版本也是被经常使用的版本。JDK中使用的就是这个版本。</li>
<li><code v-pre>基于名字的UUID（SHA1）</code> - 版本5 和基于名字的UUID算法类似，只是散列值计算使用SHA1（Secure Hash Algorithm 1）算法。</li>
</ul>
<p>一般选用V4版本，V1有暴露mac地址的风险，V2特定场景才会用到，V3、V5相同的输入参数得到相同的UUID</p>
<p>优缺点</p>
<ul>
<li>优点：简单可靠</li>
<li>缺点：不可排序，不利于检索</li>
</ul>
<h4 id="mysql自增id" tabindex="-1"><a class="header-anchor" href="#mysql自增id" aria-hidden="true">#</a> mysql自增id</h4>
<p>适用mysql的自增id机制，满足 递增性、单调性、唯一性。</p>
<ul>
<li>在单机情况下，如果并发量高，mysql的压力会很大。</li>
<li>分布式情况下，一般需要设定每台机器初始ID，来避免ID重复。这种方式有局限性，且水平扩展方案复杂，容易 出问题。</li>
</ul>
<p>优缺点</p>
<ul>
<li>优点：简单可靠，在单机、并发不高、数据量较小的情况下适用</li>
<li>缺点：在分库分表、高并发场景下不适用</li>
</ul>
...
<p>单机和分布式的优缺点与mysql类似</p>
<h4 id="snowflake" tabindex="-1"><a class="header-anchor" href="#snowflake" aria-hidden="true">#</a> snowflake</h4>
...
<li><strong>第2位</strong>开始的41位是时间戳，41-bit位可表示2^41个数，每个数代表毫秒，那么雪花算法可用的时间年限是 <code v-pre>(1L&lt;&lt;41)/(1000L360024*365)</code>=69 年的时间。</li>
...
<p>算法结构</p>
<figure><img src="@source/Java/eightpart/personal_images/image-20220709155254210.png" alt="image-20220709155254210" tabindex="0" loading="lazy"><figcaption>image-20220709155254210</figcaption></figure>
<p>优势：</p>
<ul>
<li>单机可在一毫秒内生成4096个唯一ID</li>
<li>因为最高位是时间戳，所以snowflake生成的ID都是按时间趋势递增</li>
<li>因为有 workerId来做区分，所以整个分布式系统内不会产生重复ID</li>
</ul>
<p>最大的问题：时钟回拨</p>
<p>snowflake非常依赖系统时间的一致性，如果发生系统时间的回调，改变，就可能会发生id的重复</p>
<p>下面是我总结的几种解决方法：</p>
<ul>
<li>简单粗暴，直接抛出错误，让业务层去解决</li>
<li>关闭服务器时间同步</li>
<li>保存过去一小时，每个毫秒的序号使用情况。如果时间回退到某一毫秒，可以使用这一毫秒的序号，继续生成ID</li>
<li>生成ID的时间，不实时跟随服务器时间，当1毫秒内的序号全部用完，才跳到下一毫秒。如果生成ID的并发量不大，就有很大的余量时间没有使用，就算时钟回退了，也是回退到没有被使用的时间。</li>
</ul>
<p>优缺点</p>
<ul>
<li>优点：生成的ID趋势递增，生成效率高，可保证不重复</li>
<li>缺点：时钟回拨问题处理起来复杂，容易出现问题</li>
</ul>
<h4 id="ksuid" tabindex="-1"><a class="header-anchor" href="#ksuid" aria-hidden="true">#</a> ksuid</h4>
<p>算法结构</p>
<figure><img src="@source/Java/eightpart/personal_images/image-20220709155341400.png" alt="image-20220709155341400" tabindex="0" loading="lazy"><figcaption>image-20220709155341400</figcaption></figure>
<p>ksuid由两部分组成</p>
<ul>
...
<ul>
<li>因为最高位是时间戳，所以snowflake生成的ID都是按时间趋势递增</li>
<li>而128位的号码空间，在一秒内出现随机碰撞的概率非常之低，1/2^128 约等于明天陨石撞地球的概率</li>
<li>没有序号则可以避免snowflake的时钟回拨问题</li>
</ul>
<p>优缺点</p>
<ul>
<li>优点：生成的ID趋势递增，生成效率高，没有时钟回拨的问题</li>
<li>缺点：有随机部分，理论上存在随机碰撞的可能</li>
</ul>
...
<p>对比了5种解决方案。在我的业务场景下，我选择简单可靠的ksuid算法来生成唯一ID</p>
<h3 id="单点登录" tabindex="-1"><a class="header-anchor" href="#单点登录" aria-hidden="true">#</a> 单点登录</h3>
<p>单点登录的英文名叫做：Single Sign On（简称<strong>SSO</strong>）。</p>
<p>在<strong>初学/以前</strong>的时候，一般我们就<strong>单系统</strong>，所有的功能都在同一个系统上。</p>
<h3 id="dubbo面试汇总" tabindex="-1"><a class="header-anchor" href="#dubbo面试汇总" aria-hidden="true">#</a> Dubbo面试汇总</h3>
<h4 id="什么是-dubbo" tabindex="-1"><a class="header-anchor" href="#什么是-dubbo" aria-hidden="true">#</a> 什么是 Dubbo?</h4>
...
<figure><img src="@source/Java/eightpart/personal_images/image-20220726154002025.png" alt="image-20220726154002025" tabindex="0" loading="lazy"><figcaption>image-20220726154002025</figcaption></figure>
<p>简单来说就是： <strong>Dubbo 不光可以帮助我们调用远程服务，还提供了一些其他开箱即用的功能比如智能负载均衡。</strong></p>
<h4 id="dubbo-的负载均衡策略" tabindex="-1"><a class="header-anchor" href="#dubbo-的负载均衡策略" aria-hidden="true">#</a> Dubbo 的负载均衡策略</h4>
...
<figure><img src="@source/Java/eightpart/personal_images/image-20220726154345877.png" alt="image-20220726154345877" tabindex="0" loading="lazy"><figcaption>image-20220726154345877</figcaption></figure>
...
<h5 id="randomloadbalance" tabindex="-1"><a class="header-anchor" href="#randomloadbalance" aria-hidden="true">#</a> RandomLoadBalance</h5>
...
<figure><img src="@source/Java/eightpart/personal_images/image-20220726154405163.png" alt="image-20220726154405163" tabindex="0" loading="lazy"><figcaption>image-20220726154405163</figcaption></figure>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="leastactiveloadbalance" tabindex="-1"><a class="header-anchor" href="#leastactiveloadbalance" aria-hidden="true">#</a> LeastActiveLoadBalance</h5>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="consistenthashloadbalance" tabindex="-1"><a class="header-anchor" href="#consistenthashloadbalance" aria-hidden="true">#</a> ConsistentHashLoadBalance</h5>
...
<figure><img src="@source/Java/eightpart/personal_images/image-20220726154509626.png" alt="image-20220726154509626" tabindex="0" loading="lazy"><figcaption>image-20220726154509626</figcaption></figure>
<p>另外，Dubbo 为了避免数据倾斜问题（节点不够分散，大量请求落到同一节点），还引入了虚拟节点的概念。通过虚拟节点可以让节点更加分散，有效均衡各个节点的请求量。</p>
<figure><img src="@source/Java/eightpart/personal_images/image-20220726154517156.png" alt="image-20220726154517156" tabindex="0" loading="lazy"><figcaption>image-20220726154517156</figcaption></figure>
<p>官方有详细的源码分析：<a href="https://dubbo.apache.org/zh/docs/v2.7/dev/source/loadbalance/#23-consistenthashloadbalance" target="_blank" rel="noopener noreferrer">https://dubbo.apache.org/zh/docs/v2.7/dev/source/loadbalance/#23-consistenthashloadbalance<ExternalLinkIcon/></a> 。</p>
<h5 id="roundrobinloadbalance" tabindex="-1"><a class="header-anchor" href="#roundrobinloadbalance" aria-hidden="true">#</a> RoundRobinLoadBalance</h5>
<p>加权轮询负载均衡。</p>

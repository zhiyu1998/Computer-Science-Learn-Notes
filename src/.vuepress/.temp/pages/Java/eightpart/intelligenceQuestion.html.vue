<template><div><h2 id="🙇‍♂️智力题" tabindex="-1"><a class="header-anchor" href="#🙇‍♂️智力题" aria-hidden="true">#</a> 🙇‍♂️智力题</h2>
<h3 id="赛马找最快的马匹-高频题" tabindex="-1"><a class="header-anchor" href="#赛马找最快的马匹-高频题" aria-hidden="true">#</a> 赛马找最快的马匹（高频题）</h3>
<p>一般有这么几种问法：</p>
<p>25匹马5条跑道找最快的3匹马，需要跑几次？参考回答：7</p>
<p>64匹马8条跑道找最快的4匹马，需要跑几次？参考回答：11</p>
<p>25匹马5条跑道找最快的5匹马，需要跑几次？参考回答：最少8次最多9次</p>
<p>建议画图表来看，将问题简单化一点，将大问题化成小问题即可，同时B站有个讲解视频还不错：<a href="https://www.bilibili.com/video/BV1KJ411g78y" target="_blank" rel="noopener noreferrer">https://www.bilibili.com/video/BV1KJ411g78y<ExternalLinkIcon/></a></p>
<p>详细解法：</p>
<p><strong>1、25匹马5条跑道找最快的3匹马，需要跑几次？</strong></p>
<figure><img src="@source/Java/eightpart/personal_images/image-20220626130705310.png" alt="image-20220626130705310" tabindex="0" loading="lazy"><figcaption>image-20220626130705310</figcaption></figure>
...
<p>所以最少比赛需要7次</p>
<p><strong>2、64匹马8条跑道找最快的4匹马，需要跑几次？</strong></p>
<p>第一步 全部马分为8组，每组8匹，每组各跑一次，然后淘汰掉每组的后四名，如下图（需要比赛8场）</p>
<figure><img src="@source/Java/eightpart/personal_images/image-20220626130716212.png" alt="image-20220626130716212" tabindex="0" loading="lazy"><figcaption>image-20220626130716212</figcaption></figure>
<p>第二步 取每组第一名进行一次比赛，然后淘汰最后四名所在组的所有马，如下图（需要比赛1场）</p>
<figure><img src="@source/Java/eightpart/personal_images/image-20220626130732424.png" alt="image-20220626130732424" tabindex="0" loading="lazy"><figcaption>image-20220626130732424</figcaption></figure>
<p>这个时候总冠军已经诞生，它就是A1，蓝域（它不需要比赛了）。</p>
<p>而其他可能跑得最快的三匹马只可能是下图中的黄域了（A2,A3,A4,B1,B2,B3,C1,C2,D1，共9匹马）</p>
<figure><img src="@source/Java/eightpart/personal_images/image-20220626130742122.png" alt="image-20220626130742122" tabindex="0" loading="lazy"><figcaption>image-20220626130742122</figcaption></figure>
<p>第三步 只要从上面的9匹马中找出跑得最快的三匹马就可以了，但是现在只要8个跑道，怎么办？</p>
<p>那就随机选出8匹马进行一次比赛吧（需要比赛一场）</p>
<p>第四步 上面比赛完，选出了前三名，但是9匹马中还有一匹马没跑呢，它可能是一个潜力股啊，那就和前三名比一比吧，这四匹马比一场，选出前三名。最后加上总冠军，跑得最快的四匹马诞生了！！！（需要一场比赛）</p>
<p>最后，一共需要比赛的场次：8 + 1 + 1 + 1 = 11 场</p>
<p><strong>3、25匹马5条跑道找最快的5匹马，需要跑几次？</strong></p>
...
<p><strong>仔细想一下，如果需要减少比赛场次，就一定需要在某一次比赛中同时决出2个名次，而且每一场比赛之后，有一些不可能进入前5名的马可以提前出局。</strong></p>

...
![image](5xuChryJu80-Tkpdbi27ng63nUeL8pXiawMLcxKCII8.png)
...
![image](HWKQ4tQz6gnsZPZ4RK449Y7D97KfYIr_6UhwQj5yPso.png)
...
![image](y3pml_XolV6nSlmW2_u2zaIGs0CD6U5eDil18u8uvQE.png)

Demo1

![image](SnU1fTcg78I0zLGk9y8ML8TcoZlowF53QBWga1oAO0Q.png)
...
![image](woLT-5i5UU7iWKwZNZ33OWrBZFqylmoIBHG8OXEuF6g.jpg)
...
![image](-9AEN_je35csLbssE4spcOctd8SIZnrzS_sSs57zA30.jpg)

从Jvisualvm中可以看

![image](8pk0Fs8hxBrNERdk_r7XM0aM3vfqgbDClfVrkdO3jVU.png)

* 约定：`新生区 = 新生代 = 年轻代`、 `养老区 = 老年区 = 老年代`、 `永久区 = 永久代`
* 堆空间内部结构，JDK1.8之前从`永久代` 替换成 `元空间`
* 堆空间逻辑上包括 `永久代/元空间`，实际上控制不到

![image](5wFnckgq2e5bTL9ziAQzLijRZgFh2FGB8kJkhHu7EFk.png)
...
![image](Wg50jd0w8msymHYP187QyvijPDVeR1k3u_QYW2w0_1o.png)
...
![image](q-BsvloTprgm1FJzbpXyDsiGHUiV5G8XucWWMPP359M.png)
...
![image](cnnTi09WTD_rXlIob1ynTxn9MKVBh-KXAjEzqHESAGY.png)

总的加起来是：614400，再除以1024，得到575

但是显示的是：

![image](UJw5J848UTdqpwpl2F3m3z-fB8Rv5NKMkfYwwJOC5zs.png)
...
![image](Z90oAGxEpLhxH0CBTP0jqIDIDZGc2fyS5k9h37p_no8.gif)

最后超过堆空间造成OOM错误

![image](AU2yQ9wTfybOR29KkNbPHvUxUMn_5R-przkfr7lrz78.png)
...
![image](cqNus0vKUjlAduaNYEEUtjxyLhagiC6f_la1d_ZglPI.jpg)
...
![image](gl7PulTEyXi9t998zDd828pDB2mCE3-6eYvs9ZqRhfM.png)
...
![image](if14UlfNEFM6CxKJwBHC430lWvlJ9x2S1oFh3g60cwk.png)
...
![image](-s2rVc30UvQL2JBJvpmQT88PZnMMUy4nEtqCjp0WIxU.png)
...
![image](7-22jaKigah4tHvxBIX-qJHna1XbxXKy_JC_B3H5pGw.png)



> 换VM参数为：-XX:SurvivorRatio=8

![image](vVb9bpYPmnpsteUhSEIrIfI7XDPaPi9qYZyd9W2pba8.png)

![image](cCFpiEe2sRj4WiaVIV8M1cxCjBQfDm_2bU37o5AA8LI.png)
...
## 图解对象分配(重要)
![image](bXj1AaMZ1N4kfaoUSUTWVcZxnniZ_ZgBMBeiTUIrF1k.jpeg)
...
![image](-rdu3VlMcNQ4i-qfbHHHQkgJ1U5oQMEELHINFawwd2k.png)
...
![image](N9cDFrsI1wDWJQPO_xcCO-lD3NJZz59lfbcJh9s2t-c.png)

3. 我们继续不断的进行对象生成和垃圾回收，当Survivor中的对象的年龄达到15的时候，将会触发一次 Promotion 晋升的操作，也就是将年轻代中的对象晋升到老年代中

![image](3M8xNtOIscxDTOnXfxnUs48NzLLbq9mRC5nNSfX_Vus.png)
...
![image](-ZYwK6WBVSnoJ_cniXSPy8M06fNaTMKbC28e5Zf9dvU.png)
...
![image](L1MZrcIdwqD7KQ5VsmmDxrCY4U4Mw1BxhbZed2lZjZc.png)

* 点击 Instrumentation

![image](IHk51nmXSpQsxnjMeCCYKQe6cJK-AX3ZasyKa-p4XDQ.png)
...
![image](3YyIM3EyKSvJ53g6sa-2VKqX3jBdWDKyhp-mFjX2-e4.png)
...
![image](q-SgwHuBhDFopoipowGGDQw4kCyJgeIgw3SqsNlVrVI.png)
...
![image](SBzMAqDvFgz1bOFw2k53PcAe52ICJ6E7vo-raqopZBg.png)
...
![image](JgX5ocf5_kqRVoPXSwDwUHKncYw20jpVQLJI-qeQ8OE.png)
...
![image](rJIxzrhBni3Ne9DNOhkblkgwr3jGwEJTJk768bI1saY.png)
...
### 过程详解
![image](EaidogFnVxfwVHDT-jRxUSOQYYFuduM76dYbTkkDx9g.jpg)
...
![image](DSBTBgPy4Y1yJj-lQjP_9sVAR-R2YyLFkNElDYMsaL0.png)
...
![image](fVP-1ufq7Z62dCEY3Iz2Lj3xZfqhZiXa05wJlnmnXqg.png)
...
![image](py6qZbSRhDZ6tZhg73idSYxgBXGOyXPuU2Nuz30D81M.png)

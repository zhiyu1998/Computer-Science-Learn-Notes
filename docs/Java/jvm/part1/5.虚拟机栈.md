...
![image](fRXOugtw4tiQchlKWWHkd0X1gRrG96s8E-_HH4aXN_Y.png)
...
![image](0XIXN182ik7AIvq7zF0cwIbl9u9RhTkCswUO5Zckw90.png)
...
![image](ygbip8-zvGYZ4DRc3cBeddjl-6I1OXuUbRUjZeRLM-k.jpg)
...
![image](uGoUUZGJk8lB_GKogshAb83lWzrWwEf8R7ikqxL0hRg.png)
...
![image](haRY-DBke3UiKSGEOUSnagoSIvFrRj6MFsdyAvJ-Whk.jpg)
...
![image](fiv6bgdsLJyQSsKawVmZKZI2jj0WL7JcS-Kd7bht8YY.png)

以及可以查看异常和杂项（字节码的长度、最大深度）

2. 通过LineNumberTable可以查看每一个字节码指令的位置对应代码的位置

![image](SUfU7ZiaVchYvLMzgT8trzP_qfjPcvgKD3Gx3ZR3pus.png)

3. 以及可以查看局部变量表的信息

![image](L5KG51fIZAmJJwAcbZegnU9jnovYmr9EzzCdq84wf6o.png)
...
![image](5G3YqC8Lbq-v-TVx5vMZtW0jYvDidsmOPTvBg_UyjOw.png)
...
![image](m2juSRh5abz449TXSKNVBJTgSrCKNhZDEUjGWQIKvzM.png)
...
![image](3KxJIQdnfuvQ2XABgG0uLWG9zQOiAMTYtIqL_VtUYJU.png)
...
![image](JPrQFYxCPDZ2bnMvFqPh8pBmlIww-7a3fbMAMqLykIU.png)
...
![image](gC43Vh646Rv2Ui_dKWHNu76zKRZ5YJZN7oBBMOQtssQ.png)



![image](W3xcd9VCefaPVA2zcR7SUZfgs5eD6vXpMr_fqQBBhhc.png)
...
![image](7D-JEONPqXXIhzrVXW1rJViJrzRi43lw61vQW4R1V5s.png)

大致思路可以联想此图

![image](rJhae--4U1CaSOQjvUZlBpNN1nJZCwaQf1TaODiDZwI.png)
...
![image](A6U2HiAWYQH0HrjId7-5YXPppkB9LU-EG9VLSx7IiJ4.png)

* m改成800之后，byte存储不了，就成了short型，sipush 800

![image](RC3ToH7-1fLidjgS7p3T2zTqQan9gBf9sSS7h0EDbfk.png)
...
![image](aCN_H57PJ0iRifl9TTtRmTGGRfwccc8UvDn0k1jKNuE.png)

![image](Bwowm-8waOdNnbxS1rIlByepb5EiD8z1ovOhaeHIU5c.png)
...
![image](NNzdzjVIn81bjQCQikIz-xXAGHletybZjyoy8hHX57E.jpg)
...
![image](n_emFyb3vw9wJKqwmfjUYz2NmvhzFklfjhLD2heEJTk.webp)
...
![image](dHHAh2WohuGQfugMdi9vKRteOL3gew1MOQ4piJqc4gw.jpeg)

![image](MAswxJJqSKJHurDiyIgVMFiyC89-xX4UhBHrHoq1A4k.png)

![image](GPZKPvQH8ikCYUutmUpyNioRUCuO5ibUtfgrfbJ4FT8.png)
...
![image](3TyBX_x5g1lq3Tapc46ClML0_Z44L3Cd5F3lLxfv4MA.png)
...
![image](hcXu2U-_rWzxKt4zkOdtk_hTYSme9Wen5eAROq07MZA.png)

![image](p4BtH-n8tyhjizpEnFu8y1Stk-H0vE6-fav2aHb6wOY.png)

![image](c_HtB6XTFRkJUrSZ9a7Zs7F0njNUSH67LQQeQdv6Hvw.png)

![image](CQyB7zx7B4dY-0JdXALZwaHCRrnO6dO2_iok62HP_E0.png)

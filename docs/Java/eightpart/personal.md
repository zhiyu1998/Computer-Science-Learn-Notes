...
> 这是Redis作者推荐的分布式集群情况下的方式，请看这篇文章[Is Redlock safe?](http://antirez.com/news/101)[ ](http://antirez.com/news/101)
...
![img](images/public-key-cryptography.22f51898.png)
...
![img](images/symmetric-encryption.20454cea.png)
...
SL/TLS 介绍到这里，了解信息安全的朋友又会想到一个安全隐患，设想一个下面的场景：
...
![img](images/attack1.48b62b2e.png)
...
![img](images/digital-signature.c80badfc.png)
...
![img](images/public-key-transmission.a8809fd8.png)

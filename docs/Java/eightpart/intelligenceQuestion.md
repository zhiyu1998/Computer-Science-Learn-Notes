...
![image-20220626130705310](./personal_images/image-20220626130705310.png)
...
![image-20220626130716212](./personal_images/image-20220626130716212.png)

第二步 取每组第一名进行一次比赛，然后淘汰最后四名所在组的所有马，如下图（需要比赛1场）

![image-20220626130732424](./personal_images/image-20220626130732424.png)

这个时候总冠军已经诞生，它就是A1，蓝域（它不需要比赛了）。

而其他可能跑得最快的三匹马只可能是下图中的黄域了（A2,A3,A4,B1,B2,B3,C1,C2,D1，共9匹马）

![image-20220626130742122](./personal_images/image-20220626130742122.png)
